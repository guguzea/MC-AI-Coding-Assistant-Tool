...
// 或选择性引入单个模块
dependencies {
    modImplementation "net.fabricmc.fabric-api:fabric-api-base:0.4.29+1.20.1"
    modImplementation "net.fabricmc.fabric-api:fabric-command-api-v2:2.2.11+1.20.1"
    modImplementation "net.fabricmc.fabric-api:fabric-networking-api-v1:1.3.8+1.20.1"
    modImplementation "net.fabricmc.fabric-api:fabric-screen-api-v1:2.2.7+1.20.1"
}
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-loot-api-v2:2.1.0+1.20.1"
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-key-bindings-v0:1.0.0+1.20.1"
```
