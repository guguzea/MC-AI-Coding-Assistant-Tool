...
Fabric **没有** Forge/NeoForge Capability 注册表。往实体挂数据：字段 + NBT，或等更高版本的 Attachment API（本档 1.20.1 索引中无 AttachmentRegistry）。
...
物品分组用 `ItemGroupEvents`，不是假 Capability API。
