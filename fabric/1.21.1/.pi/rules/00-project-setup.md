...
IF 这是新项目（没有 build.gradle）
  → 使用 fabric/1.21.1/scaffold/ 中的模板生成项目骨架
...
IF 报错包含 "Could not find net.fabricmc:yarn"
  → 确认 gradle.properties 中 yarn_mappings 版本格式正确（如 1.21.1+build.2）
...
## 示例：正确的 build.gradle 结构（Fabric 1.21.1）
