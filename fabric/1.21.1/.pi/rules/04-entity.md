...
// ✅ 1.21.x 方式：直接在 EntityType.Builder 中设置
public static final RegistrySupplier<EntityType<MyPigEntity>> MY_PIG = Registry.register(
    Registries.ENTITY_TYPE,
    new Identifier(MOD_ID, "my_pig"),
    EntityType.Builder.create(
...
// 注册属性（1.21.x 使用 EntityAttributeSupplement）
@Env(Env.Type.SERVER)
public class ExampleMod implements FabricMod {
    @Override
    public void onInitialize() {
        // 使用 EntityAttributeSupplementRegistry 注册
        EntityAttributeSupplementRegistry.register(MY_PIG, entity ->
