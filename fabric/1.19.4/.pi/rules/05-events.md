...
```groovy
modImplementation "net.fabric.sdk:fabric-events-attack-v0:0.2.4"
modImplementation "net.fabric.sdk:fabric-events-interaction-v0:0.6.1"
modImplementation "net.fabric.sdk:fabric-events-lifecycle-v0:1.17.0"
```

```java
// Fabric Events API 扩展
AttackEvents.AFTER_DAMAGE.register((entity, source, amount, source, flag) -> {
    // 攻击后逻辑
    return ActionResult.PASS;
});
```
