...
# GUI 开发（Fabric 1.18.2）

Yarn 移位是 `transferSlot`（[yarn 1.18.2 ScreenHandler.mapping](https://github.com/FabricMC/yarn/blob/1.18.2/mappings/net/minecraft/screen/ScreenHandler.mapping)）。不要抄 wiki 现页 `quickMove`。容器屏：`ScreenRegistry.register` 或 `HandledScreens.register`。
