---
name: mc-networking
description: Fabric 网络通信。ClientSidePacketRegistry、ServerSidePacketRegistry、PacketByteBuf。触发词：网络、Networking、PacketByteBuf
platform: fabric
version: "1.17.1"
dependencies: []
mappings: yarn
...
```java
// 服务端向客户端发送
ServerSidePacketRegistry.INSTANCE.sendToPlayer(player, MY_PACKET_ID,
