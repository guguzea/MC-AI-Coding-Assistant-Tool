...
本目录是 **Fabric 1.17.1 专属知识库**，与 `AGENTS.md`、`.cursor/rules/` 的分工如下：
...
└── knowledge/             ← Fabric 平台反模式知识库
    ...
    └── version-changes/  ← MC 1.17.x 版本变更记录
```
...
| MC 1.20.x 变更 | `version-changes/1.20.x.md` |
