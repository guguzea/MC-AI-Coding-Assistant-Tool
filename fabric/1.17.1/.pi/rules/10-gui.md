...
Yarn 移位是 `transferSlot(PlayerEntity, int)`（[yarn 1.17.1 ScreenHandler.mapping](https://github.com/FabricMC/yarn/blob/1.17.1/mappings/net/minecraft/screen/ScreenHandler.mapping)）。wiki 现页 `quickMove` 是 **1.19.4+** Yarn，不要抄进本档。
