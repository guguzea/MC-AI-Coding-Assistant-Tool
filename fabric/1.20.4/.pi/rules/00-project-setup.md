...
- **必须使用 Java 17**（Fabric 1.20.4 要求；Java 21 仅在 Minecraft 1.21+ 才需要）
...
IF 报错包含 "Could not find net.fabricmc:yarn"
  → 确认 gradle.properties 中 yarn_mappings 版本格式正确（如 1.20.4+build.3）
...
## 示例：正确的 build.gradle 结构（Fabric 1.20.4）
