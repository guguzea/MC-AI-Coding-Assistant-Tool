# Yarn Mappings 反模式（Fabric 1.20.4）
...
dependencies {
    // ❌ 缺少 v2 后缀
    mappings "net.fabricmc:yarn:1.20.4+build.10"
}
```
...
dependencies {
    // ✅ 必须包含 :v2 后缀
    mappings "net.fabricmc:yarn:1.20.4+build.10:v2"
}
```
...
dependencies {
    ...
    mappings "org.parchmentmc:parchment:1.20.4-2024.XX.XX@zip"
}
```
