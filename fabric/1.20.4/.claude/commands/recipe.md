...
本文件描述 Fabric 1.20.4 平台上进行配方（Recipe）系统开发时所需掌握的核心 API 和常用命令。
...
```groovy
dependencies {
    modApi "net.fabricmc.fabric-api:fabric-datagen-api-v0:4.2.1+1.20.4"
}
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-recipes-api-v1:1.0.0+1.20.4"
```
