...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-screen-api-v1:9.1.1+build.3"
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-loot-api-v2:2.1.0+build.3"
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-key-bindings-v0:1.0.0+build.3"
```
...
| fabric-item-api-v1 | 1.5.3+build.3 | 物品 API |
| fabric-object-builder-api-v1 | 1.0.1+build.3 | 对象构建器 |
| fabric-loot-api-v2 | 2.1.0+build.3 | Loot Table |
| fabric-datagen-api-v0 | 4.2.1+build.3 | 数据生成 |
| fabric-rendering-v0 | 1.1.33+build.3 | 渲染基础 |
| fabric-renderer-api-v1 | 2.2.0+build.3 | 渲染 API |
