...
本文件描述 Fabric 1.21.11 平台上进行粒子（Particle）系统开发时所需掌握的核心 API 和常用命令。
...
// 客户端接收并显示（在 ClientModInitializer 中）
ClientPlayNetworking.registerGlobalReceiver(PARTICLE_PACKET_ID, (payload, context) -> {
