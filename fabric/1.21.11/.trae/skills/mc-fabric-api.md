...
dependencies {
    ...
    modImplementation "net.fabricmc.fabric-api:fabric-command-api-v2:2.2.11+build.58"
    modImplementation "net.fabricmc.fabric-api:fabric-networking-api-v1:1.3.8+build.14"
    modImplementation "net.fabricmc.fabric-api:fabric-screen-api-v1:2.2.7+build.5"
}
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-loot-api-v2:2.1.0+build.33"
```
...
```groovy
modImplementation "net.fabricmc.fabric-api:fabric-keybindings-api-v1:1.0.0+build.2"
```
...
| fabric-command-api-v2 | 2.2.11+build.58 | 命令注册 |
| fabric-networking-api-v1 | 1.3.8+build.14 | 网络通信 |
| fabric-screen-api-v1 | 2.2.7+build.5 | Screen 扩展 |
| fabric-item-api-v1 | 1.5.3+build.7 | 物品 API |
| fabric-object-builder-api-v1 | 1.0.1+build.8 | 对象构建器 |
| fabric-loot-api-v2 | 2.1.0+build.33 | Loot Table |
| fabric-datagen-api-v0 | 4.2.1+build.14 | 数据生成 |
| fabric-rendering-v0 | 1.1.33+build.9 | 渲染基础 |
| fabric-renderer-api-v1 | 2.2.0+build.5 | 渲染 API |
