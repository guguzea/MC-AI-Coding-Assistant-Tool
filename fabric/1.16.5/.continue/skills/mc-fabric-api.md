...
// 或选择性引入单个模块
dependencies {
    modImplementation "net.fabric.sdk:fabric-api-base:0.4.29+1.20.1"
    modImplementation "net.fabric.sdk:fabric-command-api-v2:2.2.11+1.20.1"
    modImplementation "net.fabric.sdk:fabric-networking-api-v1:1.3.8+1.20.1"
    modImplementation "net.fabric.sdk:fabric-screen-api-v1:2.2.7+1.20.1"
}
```
...
```groovy
modImplementation "net.fabric.sdk:fabric-screen-api-v1:9.1.1+1.20.1"
```
...
```groovy
modImplementation "net.fabric.sdk:fabric-loot-api-v2:2.1.0+1.20.1"
```
...
```groovy
modImplementation "net.fabric.sdk:fabric-key-bindings-v0:1.0.0+1.20.1"
```
...
| 模块 | 版本 | 用途 |
|------|------|------|
| fabric-api-base | 0.4.29+1.20.1 | 基础工具类 |
| fabric-command-api-v2 | 2.2.11+1.20.1 | 命令注册 |
| fabric-networking-api-v1 | 1.3.8+1.20.1 | 网络通信 |
| fabric-screen-api-v1 | 2.2.7+1.20.1 | Screen 扩展 |
| fabric-item-api-v1 | 1.5.3+1.20.1 | 物品 API |
| fabric-object-builder-api-v1 | 1.0.1+1.20.1 | 对象构建器 |
| fabric-loot-api-v2 | 2.1.0+1.20.1 | Loot Table |
| fabric-datagen-api-v0 | 4.2.1+1.20.1 | 数据生成 |
| fabric-rendering-v0 | 1.1.33+1.20.1 | 渲染基础 |
| fabric-renderer-api-v1 | 2.2.0+1.20.1 | 渲染 API |
