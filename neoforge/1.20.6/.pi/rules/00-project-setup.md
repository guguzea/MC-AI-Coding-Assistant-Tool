---
description: 00 — 工程（NeoForge 1.20.6）
globs:
alwaysApply: true
status: ready
---

# 00 — 项目结构（NeoForge 1.20.6）

来源：search_neoforge_docs `gettingstarted` / `gettingstarted/modfiles`（version=1.20.6）。不要用 ForgeGradle / Yarn 冒充。
