---
description: 03 — 物品（NeoForge 1.20.6）
---

# 03 — 物品（NeoForge 1.20.6）

来源：https://docs.neoforged.net/docs/1.20.6/items/
...
禁止：`RegistryObject<Item>` 当 NeoForge 1.20.6 持有类型；禁止 Fabric `Registry.register` 冒充。
