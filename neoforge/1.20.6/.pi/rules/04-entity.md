...
来源：本档 `search_neoforge_docs` 的 `entities` 页**可查**（A-43 活体复核 2026-09-19：`get_neoforge_doc_full --id=entities --version=1.20.6` = `ok:true`；旧稿「没有独立页 / `DOC_NOT_FOUND`」是过期前提，已作废）。
