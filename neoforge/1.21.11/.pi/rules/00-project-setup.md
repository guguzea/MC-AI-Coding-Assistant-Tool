...
public class ExampleMod {
    ...
    // 合法示例；本档 scaffold src/main/java/com/example/examplemod/ExampleMod.java:46 即此单参形态
    public ExampleMod(IEventBus modEventBus /* 可选再加 ModContainer modContainer，以你实跑的 MDK 产物为准 */) {
