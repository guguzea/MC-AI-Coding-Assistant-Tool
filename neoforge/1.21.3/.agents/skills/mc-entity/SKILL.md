---
name: mc-entity
description: NeoForge 1.21.3 mc-entity。类名只来自本档核实表与 search_neoforge_docs。
platform: neoforge
version: "1.21.3"
dependencies: []
mappings: mojmap
...
生成、属性、生成蛋：必须 search_neoforge_docs query=entities version=1.21.3。核不到则禁止输出。文档：https://docs.neoforged.net/docs/1.21.3/entities/
