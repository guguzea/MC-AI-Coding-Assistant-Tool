...
> ℹ️ 本版官方文档已改组：gui/menus、gui/screens 页在本版不存在，对应内容位于 inventories/menus 与 rendering/screens（均已离线入库，search_neoforge_docs 可查；不要引用旧 gui/* 路径当本版 API）。
