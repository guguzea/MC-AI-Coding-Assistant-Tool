---
description: 00 — 工程（NeoForge 1.21.5）
globs:
alwaysApply: true
status: ready
---

# 00 — 项目结构（NeoForge 1.21.5）

来源：search_neoforge_docs `gettingstarted` / `gettingstarted/modfiles`（version=1.21.5）。不要用 ForgeGradle / Yarn 冒充。
