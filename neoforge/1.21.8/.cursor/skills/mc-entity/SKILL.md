---
name: mc-entity
description: NeoForge 1.21.8 mc-entity。类名只来自本档核实表与 search_neoforge_docs。
platform: neoforge
version: "1.21.8"
dependencies: []
mappings: mojmap
...
# mc-entity（NeoForge 1.21.8）

Java 21。资源 id：ResourceLocation.fromNamespaceAndPath。核实表：knowledge/common/verified-api-1.21.8.md。
...
生成、属性、生成蛋：必须 search_neoforge_docs query=entities version=1.21.8。核不到则禁止输出。文档：https://docs.neoforged.net/docs/1.21.8/entities/
