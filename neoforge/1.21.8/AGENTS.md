# NeoForge 1.21.8 — Agent 总纲

> 只适用于 **NeoForge 1.21.8**。禁止读取 `neoforge/1.20.4 / 1.21.1 / 1.21.3 / 1.21.11 / 26.1` 或扁平 `neoforge/.cursor/rules` 来填本档类名。
...
00-project-setup → 01-registry → 主题文件 02–10。类名必须能在 `knowledge/common/verified-api-1.21.8.md` 或 `search_neoforge_docs` 该版页面找到。反编译摘要缺少 `mappingsVersion` 不得写进规则。
