...
IF 这是新项目（没有 build.gradle）
  → 使用 forge/1.15.2/scaffold/ 中的模板生成项目骨架
...
## 示例：正确的 build.gradle 结构（Forge 1.15.2）
...
plugins {
    ...
    id 'idea'
    id 'maven-publish'
    id 'net.minecraftforge.gradle' version '[4.1.4,4.2)'
}
...
- `loaderVersion` 的格式：`"[31,)"` 表示 Forge 31 及以上
