...
> 一手来源：`forge/1.15.2/knowledge/common/resourcepack-format.md`（方块状态/方块模型/物品模型节 + 「Forge 模型层叠」节）；进一步语料页：`data/forge_1.15.2/forge-docs/1.15.2/processed/models_files.md`、`blocks_blocks.md`、`datagen_modelproviders.md`。
...
- Forge 模型层叠（overrides 分层贴图机制）形状见速查专节。
...
- 完整 JSON 形状：`forge/1.15.2/knowledge/common/resourcepack-format.md`。
- 骨架生成：`generate_model`；反模式库：`forge/1.15.2/knowledge/antipatterns/`。
