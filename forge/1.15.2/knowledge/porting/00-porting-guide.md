...
| 1.19.4 | 44.1.x | Java 17 | 8.x | 6.x |
| 1.20.1 | 47.2.x | Java 17 | 8.x | 6.x |

> **Java 列有出处**：各版官方 `gettingstarted.md`（1.15.2:14 / 1.16.5:14 / 1.17.1:14 / 1.18.2:14 / 1.19.4:15 / 1.20.1:15）。
> **Forge / Gradle / ForgeGradle 三列不是官方口径**：上游语料没有给出各版对应表。本仓 `scaffold/` 实测值为
> 1.15.2 = FG `[4.1,4.2)` + Gradle 7.3.3、1.16.5 = FG `[4.1,4.2)` + 7.6、1.17.1 = FG `5.1.+` + 7.2、
> 1.18.2 = FG `[5.1.2,5.2)` + 7.6、1.19.4 = FG `[6.0,6.2)` + 8.8、1.20.1 = FG `[6.0,6.2)` + 8.5
