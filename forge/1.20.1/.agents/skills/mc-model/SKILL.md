...
> 一手来源：`forge/1.20.1/knowledge/common/resourcepack-format.md`（方块状态/方块模型/物品模型节 + 「Forge 模型层叠」节）；进一步语料页：`data/forge_1.20.1/forge-docs/1.20.1/processed/datagen_client_modelproviders.md`、`rendering_modelextensions_facedata.md`。
...
- 完整 JSON 形状：`forge/1.20.1/knowledge/common/resourcepack-format.md`。
- 骨架生成：`generate_model`；反模式库：`forge/1.20.1/knowledge/antipatterns/`。
