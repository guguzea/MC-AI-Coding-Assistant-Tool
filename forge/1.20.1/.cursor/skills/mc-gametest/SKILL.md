...
来源页 id：`misc_gametest` — https://docs.minecraftforge.net/en/1.20.1/misc/gametest/
...
- 官方页 id：`misc_gametest`（Game Tests）：https://docs.minecraftforge.net/en/1.20.1/misc/gametest/
- Minecraft Wiki（GameTest）：https://minecraft.wiki/w/Game_test
- 规则文件：`forge/1.20.1/.cursor/rules/`（01-registry / 07-datagen / 09-anti-patterns）
