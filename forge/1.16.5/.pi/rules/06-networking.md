...
- 使用 `level.isClientSide()` 判断当前逻辑端（**本档用 `isClientSide`**：api-index `Level` 只有 `isClientSide`；语料 `concepts_sides.md:26,33,81` 与 `blocks_interaction.md:44`；`isRemote` 在本档语料 0 命中）
