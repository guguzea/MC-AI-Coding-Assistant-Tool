...
- **推荐使用 Java 11**（Forge 1.16.5 原生支持）
- **可使用 Java 16**（Forge 1.16.5 的 ForgeGradle 4.x 支持）
...
- Gradle Wrapper 版本不低于 **Gradle 7.x**（推荐 Gradle 7.6）
...
- `gradle.properties` 必须包含：
  ...
  mappings_version=1.16.5-2021.06.09-18
...
- Parchment 映射：`1.16.5-2021.06.09-18`
...
IF 报错包含 "Incompatible Java version"
  → 确认使用 Java 11 或 16，不兼容 Java 8 或 Java 17+（1.16.5 不支持）
