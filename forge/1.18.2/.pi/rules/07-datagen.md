...
- 官方文档：`DataProvider`；`RecipeProvider#buildCraftingRecipes`；`TagsProvider#addTags`；`LootTableProvider#getTables`；`SoundDefinitionsProvider#registerSounds`
- pack_format = **8**
- **不要**把 1.20 的 `BlockLootSubProvider` 抄进来
