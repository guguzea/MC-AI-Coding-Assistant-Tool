---
name: mc-block
description: Minecraft Forge 方块开发。创建方块、方块实体、方块状态属性、实体方块接口。触发词：方块、Block、BlockEntity、EntityBlock、Properties、方块实体
platform: forge
version: "1.18.2"
dependencies: []
mappings: parchment
...
1.18.2 世界高度为 **-64 到 320**（Caves & Cliffs 更新），方块可放置在这个范围内的任何位置。
