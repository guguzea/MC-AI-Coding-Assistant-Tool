...
核实表：knowledge/common/verified-api.md（若本档无表则仅 search_forge_docs version=1.10.2）。
改口：search_docs({platform:"forge", version:"1.10.2"}) / search_forge_docs(version="1.10.2")。
