...
- 官方 1.13.2 MDK 用 `sourceCompatibility = '1.8'`（Gradle 4.9 无 `java.toolchain`）
- Gradle Wrapper 必须是官方 MDK 的 **Gradle 4.9**（不要用系统 Gradle 8/9）
...
```groovy
// 官方 1.13.2-25.0.223 MDK：plugins DSL 的 [3.2,3.3) 在 marker 上解析不到
buildscript {
    repositories {
