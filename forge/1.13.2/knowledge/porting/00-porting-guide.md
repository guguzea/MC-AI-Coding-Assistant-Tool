...
| ~~mappings~~（已消解 2026-09-23） | 原稿 `version-changes/1.13.x.md:108-109`（曾写 `mcp` / `1.13.2`） | `scaffold/gradle.properties:14-15` = `snapshot` / `20180921-1.13` | **snapshot / 20180921-1.13**（A 侧原稿已按 B 改正：`00-project-setup.mdc:47-48`、`scaffold/README_AI.md:40-41`、`1.13.x.md:108-109`、`1.19.x.md:96`；官方 1.13.2-25.0.223 MDK 同值见 `03-real-world-examples.md:23`，真机构建记录见 `pack.meta.json:12`。`data/forge_1.13.2/mappings/` 两份 zip 并存，但 FG 通道值只有 `snapshot` 有本仓实证） |
