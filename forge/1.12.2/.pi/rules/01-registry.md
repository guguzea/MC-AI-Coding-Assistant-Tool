...
// ❌ 错误：硬编码或不一致
private static final String MODID = "example_mod";  // 下划线不能用在 resource locations
...
public class ModBlocks {
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        EXAMPLE_BLOCK = new Block(Block.Properties.create(Material.ROCK))
                .setHardness(1.5f)
                .setResistance(6.0f)
...
public class ExampleMod {
    ...
    // 直接在静态字段中创建并注册
    public static final Block MY_BLOCK = new Block(Block.Properties.create(Material.ROCK))
