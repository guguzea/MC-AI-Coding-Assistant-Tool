...
# Registry 注册系统（Forge 1.20.4）

## 快速开始

**始终使用 DeferredRegister**，这是 Forge 1.20.4 官方推荐的注册方式：
...
IF 注册自定义 Registry（全新注册表）
  → 使用 NewRegistryEvent（Mod 总线）+ DeferredRegister.create(ResourceKey)
...
- Forge 官方文档：https://docs.minecraftforge.net/en/1.20.4/concepts/registries/
