...
- 官方文档：https://docs.minecraftforge.net/en/1.20.4/gameeffects/sounds
- sounds.json 规范：https://minecraft.wiki/w/Sounds.json
- DataGen 生成：https://docs.minecraftforge.net/en/1.20.4/datagen/client/sounds/
...
> 本节是机制路线：vanilla（含 1.20.4 Forge 基础）**没有**开箱即用的流式音频 API、自定义声道或混音广播接口。具体类与方法签名一律以 `search_forge_docs`（`gameeffects_sounds` 页核实数据）为准，不要凭记忆补签名。
