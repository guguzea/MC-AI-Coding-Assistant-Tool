...
> 本档核实页 id：`rendering_modelextensions_rendertypes` / `blockentities_ber` / `items_bewlr`（三页均在 `data/forge_1.20.4/forge-docs/1.20.4/index-l0.json` 命中；正文与 1.20.1 档核实稿一致）。
...
https://docs.minecraftforge.net/en/1.20.4/rendering/modelextensions/rendertypes
...
https://docs.minecraftforge.net/en/1.20.4/blockentities/ber/
...
https://docs.minecraftforge.net/en/1.20.4/items/bewlr/
...
- 规则文件：`forge/1.20.4/.cursor/rules/`（02-block / 03-item / 08-client-server / 09-anti-patterns）
