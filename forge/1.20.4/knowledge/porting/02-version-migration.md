...
>
> **当前知识库覆盖范围**：1.19.4 → 26.1。1.16 ~ 1.19.3 版本暂未覆盖，缺失时建议使用 `query_api` 工具逐类对比 API 签名。

---

## 1.20.1 → 1.20.4（Forge 小幅升级，API 一致）
...
- `build.gradle`（如使用 Parchment）：更新 `mappings channel: 'parchment', version:`
- 其他 Java 代码：**无需修改**（API 完全兼容）
