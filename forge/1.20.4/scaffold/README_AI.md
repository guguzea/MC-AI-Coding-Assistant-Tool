# Forge 1.20.4 模组项目骨架说明

> 本文件供 AI 编程助手阅读，描述每个文件的职责、修改注意事项和扩展位置。
> 当 AI 开始一个新的 Forge 1.20.4 项目时，先读本文件。
...
> | mappings | `scaffold/gradle.properties:16-17` → `parchment` / `2024.02.25-1.20.4` | `gradle.properties:35,38` → `official` / `1.20.4` |

> **取证与局限（2026-09-14 实读）**
> - 官方侧来源：`%APPDATA%\mc-skill-cache\mdk\forge\1.20.4\forgegradle\unpacked\`{gradle.properties, build.gradle, gradle/wrapper/gradle-wrapper.properties}；
...
# build.gradle 中
minecraft "net.minecraftforge:forge:1.20.4-49.0.0"  # ❌ 硬编码
