# Forge 1.20.4 — AI Coding Assistant

This file contains Forge 1.20.4 mod development knowledge for AI coding assistants that support `CLAUDE.md`.
When you detect a Forge 1.20.4 project, read this file first.
...
IF build.gradle contains "1.20.4"
  → Use Forge 1.20.4 rules
...
### Registry
- **Always use DeferredRegister** — the official Forge 1.20.4 recommended pattern
...
### Mappings
- Always use **Parchment names** for Forge 1.20.4 (e.g., `LivingEntity#getHealth`, not `func_70024_e`)
