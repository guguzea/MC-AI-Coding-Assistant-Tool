...
- 官方文档：https://docs.minecraftforge.net/en/1.17.1/resources/server/recipes/
- 非数据包配方：https://docs.minecraftforge.net/en/1.17.1/resources/server/recipes/incode/
- DataGen：https://docs.minecraftforge.net/en/1.17.1/datagen/server/recipes/
