---
name: mc-capability
description: Minecraft Forge Capability 系统。AttachCapabilitiesEvent、IStorage、ICapabilitySerializable、getCapability 存储和查询模式。触发词：Capability、IStorage、ICapabilitySerializable、AttachCapabilitiesEvent、LazyOptional、getCapability
platform: forge
version: "1.17.1"
dependencies: []
mappings: mcp
...
```java
// ItemHandler（物品栏）
player.getCapability(CapabilityItemHandler.ITEM_HANDLER)
// FluidHandler（流体栏）
player.getCapability(CapabilityFluidHandler.FLUID_HANDLER)
// EnergyStorage（能量）
...
- Forge 官方文档：https://docs.minecraftforge.net/en/1.17.1/datastorage/capabilities/
