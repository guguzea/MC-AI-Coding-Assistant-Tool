...
```java
// 注册 BlockEntityType（用 RegistryEvent）
...
- 官方文档：https://docs.minecraftforge.net/en/1.17.1/blockentities
- BER 文档：https://docs.minecraftforge.net/en/1.17.1/blockentities/ber
