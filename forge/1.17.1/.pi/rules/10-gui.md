---
description: Client-Server separation and GUI (Forge 1.17.1)
---

# Client-Server separation and GUI (Forge 1.17.1)
...
// In Menu constructor
super(MyMenuTypes.MY_MENU.get(), windowId); // A-43：AbstractContainerMenu 只有 (MenuType, int) 两个构造参数（原 5 参示例编译不过；与本文档 :81 的正解统一）
this.addDataSlots(dataSlots); // A-43：不接线则客户端收不到同步（原版漏了这一步）
