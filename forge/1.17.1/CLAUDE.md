# Forge 1.17.1 — AI Coding Assistant

This file contains Forge 1.17.1 mod development knowledge for AI coding assistants that support `CLAUDE.md`.
When you detect a Forge 1.17.1 project, read this file first.
...
IF build.gradle contains "1.17.1"
  → Use Forge 1.17.1 rules
...
### Registry
- **Use DeferredRegister** — the official Forge 1.17.1 recommended pattern
...
| File | Topic |
|------|-------|
| `00-project-setup.mdc` | Java 16, Gradle 7.x, build.gradle structure |
