...
- **推荐使用 `DeferredRegister`**：`DeferredRegister` 是 Forge 官方推荐的注册方式，自 Forge 1.18 起即可用于所有注册表，1.19.4 完全支持
...
IF 平台 = Fabric
  → 跳转 fabric/1.19.4/AGENTS.md（Fabric 使用 Registry.register() in onInitialize）
