...
> 本档核实页 id：`misc_gametest`（`data/forge_1.19.4/forge-docs/1.19.4/index-l0.json` 命中；processed 正文与 1.20.1 档核实稿内容一致，仅文件末尾空行差异）。
...
来源页 id：`misc_gametest` — https://docs.minecraftforge.net/en/1.19.4/misc/gametest/
...
- 官方页 id：`misc_gametest`（Game Tests）：https://docs.minecraftforge.net/en/1.19.4/misc/gametest/
- Minecraft Wiki（GameTest）：https://minecraft.wiki/w/Game_test
- 规则文件：`forge/1.19.4/.cursor/rules/`（01-registry / 07-datagen / 09-anti-patterns）
