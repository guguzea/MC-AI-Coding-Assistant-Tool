...
- `gradle.properties` 必须包含：
  ...
  mappings_version=1.14.4
  loader_version=28.2.0
  ```
  > 注意：
...
IF 这是新项目（没有 build.gradle）
  → 使用 forge/1.14.4/scaffold/ 中的模板生成项目骨架
...
- `loaderVersion` 的格式：`"[28,)"` 表示 Forge 28 及以上
