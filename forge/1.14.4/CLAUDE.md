# Forge 1.14.4 — AI Coding Assistant

This file contains Forge 1.14.4 mod development knowledge for AI coding assistants that support `CLAUDE.md`.
When you detect a Forge 1.14.4 project, read this file first.
...
IF build.gradle contains "1.14.4"
  → Use Forge 1.14.4 rules
...
### Registry
- **Always use DeferredRegister** — the official Forge 1.14.4 recommended pattern (introduced in 1.14)
...
| File | Topic |
|------|-------|
| `00-project-setup.md` | Java 11, Gradle 7.6, build.gradle structure |
| `01-registry.md` | DeferredRegister, RegistryObject (most important) |
| `02-block.md` | Block, EntityBlock, TileEntity |
...
4. NPE in TileEntity.read() → world accessed before fully loaded
