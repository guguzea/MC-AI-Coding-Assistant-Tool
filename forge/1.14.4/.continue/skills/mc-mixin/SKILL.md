...
> **注意**：Forge 1.14.4 的 Mixin compatibilityLevel 是 `JAVA_8`，不是 `JAVA_17`。
...
public class MixinEntity {
    @ModifyVariable(
        at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/Entity;isGlowing()Z", ordinal = 0),
        method = "isGlowing()Z"
    )
...
- ❌ `compatibilityLevel` 设为 `JAVA_17`：1.14.4 必须用 `JAVA_8`

## 参考资料

- Mixin 文档：https://github.com/SpongePowered/Mixin
- Forge Access Transformer：https://docs.minecraftforge.net/en/1.14.4/
