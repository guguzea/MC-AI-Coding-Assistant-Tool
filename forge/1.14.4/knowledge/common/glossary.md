...
### DeferredRegister
: Forge 1.14+ 推荐的注册方式。延迟注册到 `RegistryEvent`，避免在 mod 构造函数执行前引用未注册的 content。
...
: Forge 维护的 Minecraft 映射层，提供可读的命名。
