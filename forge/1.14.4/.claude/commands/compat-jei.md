...
EMI 是 JEI 的现代替代品，API 简洁，在 Fabric/NeoForge 社区更流行。
...
dependencies {
    fg.deobf "dev.emi:EMI:0.8.0+1.19.4"
}
```
...
JEI 通过 DataPack 机制工作，如需自定义显示推荐使用 EMI。
...
- ❌ 手动实现 `IRecipeCategory`/`IRecipeWrapper`（JEI 已废弃）
