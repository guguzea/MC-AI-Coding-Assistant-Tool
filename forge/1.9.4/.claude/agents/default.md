...
核实表：knowledge/common/verified-api.md（若本档无表则仅 search_forge_docs version=1.9.4）。
改口：search_docs({platform:"forge", version:"1.9.4"}) / search_forge_docs(version="1.9.4")。
