...
| QSL Core Registry | 本档对应 QSL 分支未打开到 `RegistryEvents.java`（1.20.1 路径 404）。**禁止**把 1.21 分支方法名冒充本档。已核实的 1.21 源见 `quilt/1.21.1/knowledge/common/qsl-verified.md`。改 `search_docs({platform:"quilt"})` |
