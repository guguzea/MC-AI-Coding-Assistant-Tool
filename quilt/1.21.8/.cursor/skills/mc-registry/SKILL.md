---
name: mc-registry
description: Quilt 1.21.8 mc-registry（QSL 差异）。名字只来自本档 qsl-verified.md。
platform: quilt
version: "1.21.8"
dependencies: []
...
# mc-registry（Quilt 1.21.8）

核实表：knowledge/common/qsl-verified.md。
必须 search_docs({platform:"quilt"}) 且 version=1.21.8。02–10 仍读 fabric/1.21.8 overlay。
