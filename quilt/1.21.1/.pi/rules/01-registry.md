...
- 需要监听条目添加：已核 `org.quiltmc.qsl.registry.api.event.RegistryEvents#getEntryAddEvent(Registry)`；高层监视 `RegistryMonitor#create(Registry)`（见 `05-events.mdc` / `qsl-verified.md`）
