...
> 适用：Quilt 1.19.4。**禁止编造 `QuiltRegistry.register()`。** 未核实的 QSL 方法名：停止生成，改 `search_docs({platform:"quilt"})` 或 QSL 源码 / loader-api-summaries。
...
已核实表：`quilt/1.19.4/knowledge/common/qsl-verified.md`（02–10 仍读 fabric/1.19.4）。
