...
server.registerTool(
  "query_api",
  {
    ...
    description:
      ...
      "【边界】覆盖约 1.16.5–1.20.4；26.1+ 索引为 0 个类。found:false 表示本索引没有该类，不代表游戏里不存在。平台 API 请用 search_*_docs。",
...
server.registerTool(
  "generate_datagen",
  {
    ...
    description:
      ...
      "返回完整的 Java 代码模板。" +
      "【边界】只返回 Java 模板文本，不写盘；不是所有 MC 版本的 DataGen API。",
