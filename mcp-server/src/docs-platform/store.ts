...
const KNOWN_VERSIONS: Record<Platform, string[]> = {
  ...
  neoforge: [
    // 主文档版本（按优先级排序）
    "26.2", "26.1", "1.21.11", "1.21.10", "1.21.8", "1.21.5", "1.21.3", "1.21.1", "1.20.6", "1.20.4",
    // Forge 兼容版本（复用 Forge 1.20.1 数据）
    "1.20.1",
  ],
  fabric:   ["26.2", "26.1.2", "1.21.11", "1.21.3", "1.21.1", "1.20.4", "1.20.1", "1.19.4", "1.18.2", "1.17.1", "1.16.5", "1.14.4"],
};
