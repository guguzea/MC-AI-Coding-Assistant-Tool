...
IF 不知道有没有对应库 skill
  → 按下方 §3.6 解析流程扫描 knowledge/libs 四组
```
...
1. 判定用户平台与 MC 版本（build.gradle / mods.toml / fabric.mod.json）
...
- 规则：根 AGENTS.md 第四步、knowledge/libs/README.md 使用约定
