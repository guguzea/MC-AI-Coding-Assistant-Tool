...
- `min_engine_version` 为 `[major, minor, patch]` 数组。scaffold / `generate_addon_manifest` 默认 **`[1, 26, 44]`**（npm `@minecraft/server` 最近一个 `-stable` 串 `2.10.0-beta.1.26.44-stable` 所指引擎版本，核对日期 2026-09-07）；以目标引擎为准，不要倒灌 Java 版本号。
