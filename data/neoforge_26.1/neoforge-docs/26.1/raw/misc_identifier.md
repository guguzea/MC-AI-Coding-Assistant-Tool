...
title: "Identifier"
version: "26.1"
pageId: "misc/identifier"
url: "https://docs.neoforged.net/docs/misc/identifier/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:07:57.512Z"
---
# Identifiers

`Identifier`s are one of the most important things in Minecraft. They are used as keys in [registries](/docs/concepts/registries), as identifiers for data or resource files, as references to models in code, and in a lot of other places. An `Identifier` consists of two parts: a namespace and a path, separated by a `:`.
