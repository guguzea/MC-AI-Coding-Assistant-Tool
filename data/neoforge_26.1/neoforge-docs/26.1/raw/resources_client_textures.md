...
url: "https://docs.neoforged.net/docs/resources/client/textures/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:08:15.785Z"
---
# Textures

All textures in Minecraft are PNG files located within a namespace's `textures` folder. JPG, GIF and other image formats are not supported. The path of [identifiers](/docs/misc/identifier) referring to textures is generally relative to the `textures` folder, so for example, the identifier `examplemod:block/example_block` refers to the texture file at `assets/examplemod/textures/block/example_block.png`.
