...
url: "https://docs.neoforged.net/docs/misc/updatechecker/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:07:59.513Z"
---
...
- NeoForge uses an internal algorithm to determine whether one version string of your mod is "newer" than another. Most versioning schemes should be compatible, but see the `ComparableVersion` class if you are concerned about whether your scheme is supported. Adherence to [Maven versioning](/docs/gettingstarted/versioning) is highly recommended.
