...
platform: "neoforge"
fetchedAt: "2026-09-12T12:08:11.591Z"
---
...
The [client item](/docs/resources/client/models/items) JSON (in `assets/<namespace>/items`) is compiled and baked into an `ItemModel` for a given `Item` to be used by the `ItemStack`. The process of creating the `ItemModel` goes like so:
