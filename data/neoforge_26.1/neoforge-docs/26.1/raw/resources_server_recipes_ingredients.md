...
platform: "neoforge"
fetchedAt: "2026-09-07T04:58:27.656Z"
---
# Ingredients

`Ingredient`s are used in [recipes](/docs/resources/server/recipes/) to check whether a given [ItemStack](/docs/items/#itemstacks) is a valid input for the recipe. For this purpose, `Ingredient` implements `Predicate`, and `#test` can be called to confirm if a given `ItemStack` matches the ingredient.
