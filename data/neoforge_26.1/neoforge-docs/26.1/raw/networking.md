...
platform: "neoforge"
fetchedAt: "2026-06-01T10:41:06.762Z"
---
# Networking
...
There is a technique provided by NeoForge to facilitate communication mostly built on top of [netty](https://netty.io). This technique can be used by listening for the `RegisterPayloadHandlersEvent` event, and then registering a specific type of [payloads](/docs/networking/payload), its reader, and its handler function to the registrar.
