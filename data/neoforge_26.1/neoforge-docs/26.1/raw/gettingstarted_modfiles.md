...
Most values are also explained as comments in [the MDK's gradle.properties file](https://github.com/NeoForgeMDKs/MDK-26.1-NeoGradle/blob/main/gradle.properties).
