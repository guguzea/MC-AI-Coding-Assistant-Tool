...
url: "https://docs.neoforged.net/docs/resources/client/sounds/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:58:10.574Z"
---
# Sounds
...
`SoundEvent`s are [registered objects](/docs/concepts/registries), meaning that they must be registered to the game through a `DeferredRegister` and be singletons:
...
Of course, don't forget to add your registry to the [mod event bus](/docs/concepts/events#event-buses) in the [mod constructor](/docs/gettingstarted/modfiles#javafml-and-mod):
...
Sound files themselves can of course not be [datagenned](/docs/resources/#data-generation), but `sounds.json` files can. To do so, we extend `SoundDefinitionsProvider` and override the `registerSounds()` method:
