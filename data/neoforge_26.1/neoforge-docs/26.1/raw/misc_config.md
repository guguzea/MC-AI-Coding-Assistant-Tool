...
version: "26.1"
pageId: "misc/config"
url: "https://docs.neoforged.net/docs/misc/config/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:41:21.666Z"
---
# Configuration
...
Operations that occur whenever a config is loaded, reloaded, or unloaded can be done using the `ModConfigEvent.Loading`, `ModConfigEvent.Reloading`, and `ModConfigEvent.Unloading` events. The events must be [registered](/docs/concepts/events#registering-an-event-handler) to the mod event bus.
...
A configuration screen can be registered for a mod by registering a `IConfigScreenFactory` extension point during mod construction on the [client](/docs/concepts/sides#mod):
