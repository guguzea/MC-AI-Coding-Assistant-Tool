...
url: "https://docs.neoforged.net/docs/misc/debugprofiler/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:57:57.641Z"
---
# Debug Profiler
...
Naturally, you can only profile code paths that are actually being reached. [Entitys](/docs/entities/) and [BlockEntitys](/docs/blockentities/) that you want to profile must exist in the level to show up in the results.
...
<li class="">`201` - The number of times this section was called during the profiler's runtime.</li>
<li class="">`1` - The average number of times, rounded down, this section was called during a single tick.</li>
<li class="">`99.98%` - The percentage of time taken in relation to its parent.<!-- -->

- For Layer 0, it is the percentage of the time a tick takes.
- For Layer 1, it is the percentage of the time its parent takes.

</li>
<li class="">`39.57%` - The percentage of time taken from the entire tick.</li>
</ul>
...
<li class="">`4585` - The number of times this counter was incremented during the profiler's runtime.</li>
<li class="">`22` - The average number of times, rounded down, this counter was incremented during a single tick.</li>
</ul>
