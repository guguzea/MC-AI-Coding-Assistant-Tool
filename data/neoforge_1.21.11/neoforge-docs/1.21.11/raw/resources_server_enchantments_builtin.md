...
url: "https://docs.neoforged.net/docs/1.21.11/resources/server/enchantments/builtin/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:58.382Z"
---
# Built-In Enchantment Effect Components

Vanilla Minecraft provides numerous different types of enchantment effect components for use in [enchantment](/docs/1.21.11/resources/server/enchantments/) definitions. This article will explain each, including their usage and in-code definition.
...
The object within the `value` block is a [LevelBasedValue](/docs/1.21.11/resources/server/loottables/#number-provider), which can be used to have a value effect component that changes the intensity of its effect by level.
...
- `minecraft:apply_mob_effect`: Applies a [mob effect](/docs/1.21.11/items/mobeffects) to the affected mob.
- `minecraft:attribute`: Applies an [attribute modifier](/docs/1.21.11/entities/attributes#attribute-modifiers) to the wielder of the enchantment.
