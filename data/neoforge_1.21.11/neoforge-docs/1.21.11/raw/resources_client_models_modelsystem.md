...
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:52.740Z"
---
...
The [client item](/docs/1.21.11/resources/client/models/items) JSON (in `assets//items`) is compiled and baked into an `ItemModel` for a given `Item` to be used by the `ItemStack`. The process of creating the `ItemModel` goes like so:
