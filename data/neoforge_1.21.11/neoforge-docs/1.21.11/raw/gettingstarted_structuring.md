...
url: "https://docs.neoforged.net/docs/1.21.11/gettingstarted/structuring/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:49:21.953Z"
---
...
As such, your top level package should be something that you own: a domain, email address, a (subdomain of a) website, etc. It can even be your name or username as long as you can guarantee that it will be uniquely identifiable within the expected target. Furthermore, the top-level package should also match your [group id](/docs/1.21.11/gettingstarted/#the-group-id).
