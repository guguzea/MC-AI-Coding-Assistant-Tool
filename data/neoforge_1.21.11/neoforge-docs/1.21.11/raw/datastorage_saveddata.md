...
url: "https://docs.neoforged.net/docs/1.21.11/datastorage/saveddata/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:36.753Z"
---
# Saved Data

The Saved Data (SD) system can be used to save additional data on levels.

*If the data is specific to some block entities, chunks, or entities, consider using a [data attachment](/docs/1.21.11/datastorage/attachments) instead.*
