...
platform: "neoforge"
fetchedAt: "2026-06-01T10:49:45.897Z"
---
# Biome Modifiers
...
A `BiomeModifier` JSON can be created through [data generation](/docs/1.21.11/resources/#data-generation) by passing a `RegistrySetBuilder` to `DatapackBuiltinEntriesProvider`. The JSON will be placed at `data//neoforge/biome_modifier/.json`.
