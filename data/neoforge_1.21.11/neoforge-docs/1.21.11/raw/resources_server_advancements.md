...
platform: "neoforge"
fetchedAt: "2026-06-01T10:49:40.381Z"
---
# Advancements
...
The `SimpleCriterionTrigger` implementation has two purposes: supplying a method to check trigger instances and run attached listeners on success, and specifying a [codec](/docs/1.21.11/datastorage/codecs) to serialize the trigger instance (`T`).
