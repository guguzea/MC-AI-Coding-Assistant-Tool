...
platform: "neoforge"
fetchedAt: "2026-09-12T12:09:55.203Z"
---
# Ingredients

`Ingredient`s are used in [recipes](/docs/1.21.11/resources/server/recipes/) to check whether a given [ItemStack](/docs/1.21.11/items/#itemstacks) is a valid input for the recipe. For this purpose, `Ingredient` implements `Predicate<ItemStack>`, and `#test` can be called to confirm if a given `ItemStack` matches the ingredient.
