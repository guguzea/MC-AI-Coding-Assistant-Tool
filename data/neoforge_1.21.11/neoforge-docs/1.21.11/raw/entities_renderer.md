...
platform: "neoforge"
fetchedAt: "2026-09-12T12:08:56.226Z"
---
# Entity Renderers
...
Animations are defined in JSON files located at `assets/<namespace>/neoforge/animations/entity/<path>.json` (so for the [resource location](/docs/1.21.11/misc/identifier) `examplemod:example`, the file would be located at `assets/examplemod/neoforge/animations/entity/example.json`). The format of an animation file is as follows:
