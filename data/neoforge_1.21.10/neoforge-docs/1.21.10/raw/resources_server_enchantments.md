...
platform: "neoforge"
fetchedAt: "2026-09-12T12:08:21.362Z"
---
# Enchantments
...
Enchantment JSON files can be created automatically using the [data generation](/docs/1.21.10/resources/#data-generation) system by passing a `RegistrySetBuilder` into `DatapackBuiltInEntriesProvider` via `GatherDataEvent#createDatapackRegistryObjects`. The JSON will be placed in `<project root>/src/generated/data/<modid>/enchantment/<path>.json`.
