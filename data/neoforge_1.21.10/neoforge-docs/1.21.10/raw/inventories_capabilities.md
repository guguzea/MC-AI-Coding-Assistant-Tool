...
url: "https://docs.neoforged.net/docs/1.21.10/inventories/capabilities/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:06.168Z"
---
# Capabilities
...
NeoForge provides capabilities for the following three interfaces: `ResourceHandler`, `ResourceHandler` and `EnergyHandler`.

`ResourceHandler` exposes an interface for handling inventory slots. The capabilities of type `ResourceHandler` are:
...
`ResourceHandler` exposes an interface for handling fluid inventories. The capabilities of type `ResourceHandler` are:
