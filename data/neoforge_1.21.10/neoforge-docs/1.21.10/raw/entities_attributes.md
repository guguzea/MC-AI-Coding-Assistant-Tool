...
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:03.721Z"
---
# Attributes
...
If needed, you can also add your own attributes. Like many other systems, attributes are a [registry](/docs/1.21.10/concepts/registries), and you can register your own objects to it. To get started, create a `DeferredRegister` like so:
