...
url: "https://docs.neoforged.net/docs/1.21.10/resources/client/models/datagen/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:08:04.453Z"
---
# Model Datagen

Like most JSON data, block and item models, along with their necessary blockstate files and [client items](/docs/1.21.10/resources/client/models/items), can be [datagenned](/docs/1.21.10/resources/#data-generation). This is all handled through the vanilla `ModelProvider`, with extensions provided by NeoForge via the `ExtendedModelTemplateBuilder`. Since the model JSON itself is similar between block and item models, the datagen code is relatively similar.
