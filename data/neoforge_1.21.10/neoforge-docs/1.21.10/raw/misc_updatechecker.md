...
url: "https://docs.neoforged.net/docs/1.21.10/misc/updatechecker/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:01:13.362Z"
---
...
- NeoForge uses an internal algorithm to determine whether one version string of your mod is "newer" than another. Most versioning schemes should be compatible, but see the `ComparableVersion` class if you are concerned about whether your scheme is supported. Adherence to [Maven versioning](/docs/1.21.10/gettingstarted/versioning) is highly recommended.
...
- Some examples can be found here for [nocubes](https://cadiboo.github.io/projects/nocubes/update.json), [Corail Tombstone](https://github.com/Corail31/tombstone_lite/blob/master/update.json) and [Chisels & Bits 2](https://curseupdate.com/231095/chiselsandbits?ml=neoforge).
