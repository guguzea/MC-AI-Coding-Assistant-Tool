...
source: "https://docs.minecraftforge.net/en/1.18.x/concepts/registries/"
sourceType: mkdocs
---
# Registries
...
The `RegistryEvent`s are the second and more flexible way to register objects. These [events](../events/) are fired after the mod constructors and before the loading of configs.
...
- one of the following conditions are true: the **enclosing class** has an `@ObjectHolder` annotation, and the field is `final`, and:
