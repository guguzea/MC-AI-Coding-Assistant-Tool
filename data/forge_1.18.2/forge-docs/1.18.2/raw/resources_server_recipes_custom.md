...
chapter: "resources/server/recipes/custom"
source: "https://docs.minecraftforge.net/en/1.18.x/resources/server/recipes/custom/"
sourceType: mkdocs
---
# Custom Recipes
...
If none of the existing types match what context the recipe will be used within, then a new `RecipeType` must be [registered](../../../../concepts/registries/#registries-that-arent-forge-registries).
