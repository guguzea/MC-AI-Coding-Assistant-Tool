...
source: "https://docs.minecraftforge.net/en/1.18.x/resources/server/glm/"
sourceType: mkdocs
---
...
`type` represents the registry name of the [`GlobalLootModifierSerializer`](#globallootmodifierserializer) used to read the associated JSON file. This must always be present.
