...
source: "https://docs.minecraftforge.net/en/1.18.x/datagen/client/modelproviders/"
sourceType: mkdocs
---
# Model Generation
...
A <code>BlockModelBuilder` represents a block model to-be-generated. There is no additional functionality compared to a `ModelBuilder`.
...
`SeparatePerspectiveModelBuilder` | `#begin` | Generates a model which changes based on the specified [perspective](../../../rendering/modelloaders/perspective/).
`OBJLoaderBuilder` | `#begin` | Generates an [OBJ model](../../../rendering/modelloaders/#wavefront-obj-models).
