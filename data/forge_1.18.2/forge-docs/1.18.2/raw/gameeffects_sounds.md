...
source: "https://docs.readthedocs.net/en/1.18.x/gameeffects/sounds/"
sourceType: mkdocs
---
# Sounds
...
1. <li><a name="clientlevel-playsound-becvpd"> <code>playLocalSound(BlockPos, SoundEvent, SoundCategory, volume, pitch, distanceDelay)`- <li>Simply forwards to `Level`&rsquo;s [overload (3)](#level-playsound-xyzecvpd), adding 0.5 to each coordinate of the `BlockPos` given.
