...
source: "https://docs.minecraftforge.net/en/1.18.x/resources/server/tags/"
sourceType: mkdocs
---
# Tags
...
Tags are directly supported by Vanilla. See the respective Vanilla wiki pages for [recipes](https://minecraft.wiki/w/Recipe#JSON_format) and [advancements](https://minecraft.wiki/w/Advancements) for usage details.