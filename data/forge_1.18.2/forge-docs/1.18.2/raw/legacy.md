...
If any developer wishes to contribute to this archival effort, please visit The Forge Project discord server and ask for directions to the designated channel. Please note that this initiative only aims to *preserve* these old versions for the benefit of the community, _***not** to support developing mods for these old, unsupported versions.*_ There will not be any support for using or developing for unsupported versions.