...
[Tags](/docs/1.20.6/resources/server/tags) can be generated for a mod by subclassing `TagsProvider` and implementing `#addTags`. After implementation, the provider must be [added](/docs/1.20.6/resources/#data-generation) to the `DataGenerator`.
