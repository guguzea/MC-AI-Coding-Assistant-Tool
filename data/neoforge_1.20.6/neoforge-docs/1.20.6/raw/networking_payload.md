...
url: "https://docs.neoforged.net/docs/1.20.6/networking/payload/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:01:38.287Z"
---
...
<li class="">The [stream codec](/docs/1.20.6/networking/streamcodecs) is used to read and write the payload to and from the buffer sent across the network</li>
...
With your own payloads you can then use those to configure the client and server using [Configuration Tasks](/docs/1.20.6/networking/configuration-tasks).
