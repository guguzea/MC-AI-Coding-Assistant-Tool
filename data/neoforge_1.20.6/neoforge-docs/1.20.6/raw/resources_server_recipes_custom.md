...
url: "https://docs.neoforged.net/docs/1.20.6/resources/server/recipes/custom/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:01:58.355Z"
---
# Custom Recipes
...
If none of the existing types match what context the recipe will be used within, then a new `RecipeType` must be [registered](/docs/1.20.6/concepts/registries#methods-for-registering).
...
All custom recipes, regardless of input or output data, can be provided to `RecipeOutput#accept` for [data generation](/docs/1.20.6/datagen/recipes#custom-recipe-serializers) using the `RecipeProvider`.
