...
url: "https://docs.neoforged.net/docs/1.20.6/blockentities/ber/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:00:51.594Z"
---
# BlockEntityRenderer
...
In order to register a BER, you must subscribe to the `EntityRenderersEvent.RegisterRenderers` [event on the mod event bus](/docs/1.20.6/concepts/events#registering-an-event-handler) and call `#registerBlockEntityRenderer`.
