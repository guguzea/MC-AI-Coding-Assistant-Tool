...
url: "https://docs.neoforged.net/docs/1.20.6/resources/server/recipes/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:58:04.105Z"
---
# Recipes
...
Data-driven recipes and their unlocking advancement can be [generated](/docs/1.20.6/datagen/recipes) via `RecipeProvider`.
...
Recipes and their unlocking advancement can be [loaded conditionally and defaulted](/docs/1.20.6/resources/server/conditional#implementations) depending on what information is present (mod loaded, item exists, etc.).
...
Larger crafting grids in recipes can be [data generated](/docs/1.20.6/datagen/recipes).

### Ingredient Types

A few additional [ingredient types](/docs/1.20.6/resources/server/recipes/ingredients#neoforge-types) are added to allow recipes to have inputs which check tag data or combine multiple ingredients into a single input checker.
