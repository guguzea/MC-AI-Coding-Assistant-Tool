...
url: "https://docs.neoforged.net/docs/1.20.6/resources/server/tags/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:02:01.473Z"
---
# Tags
...
- If there is a Vanilla tag that fits your registry object, add it to that tag. See the [list of Vanilla tags](https://minecraft.wiki/w/Tag#List_of_tags).
...
<li class="">If there is a NeoForge tag that fits your registry object, add it to that tag. The list of tags declared by NeoForge can be seen on [GitHub](https://github.com/neoforged/NeoForge/tree/1.20.x/src/generated/resources/data/neoforge/tags).</li>
<li class="">Tag naming conventions should follow Vanilla conventions.(e.g. plural instead of singular: `minecraft:logs`, `minecraft:saplings`).</li>
</ul>
