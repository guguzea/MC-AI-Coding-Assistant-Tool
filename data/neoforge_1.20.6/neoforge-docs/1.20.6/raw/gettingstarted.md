...
url: "https://docs.neoforged.net/docs/1.20.6/gettingstarted/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:53:44.202Z"
---
...
- Open the [Mod Developer Kit (MDK)](https://github.com/NeoForgeMDKs/MDK-1.20.6-NeoGradle) GitHub repository, click "Use this template" and clone the newly-created repository to your local machine.
...
You should always test your mod in a dedicated server environment. This includes [client-only mods](/docs/1.20.6/concepts/sides), as these should not do anything when loaded on the server.
