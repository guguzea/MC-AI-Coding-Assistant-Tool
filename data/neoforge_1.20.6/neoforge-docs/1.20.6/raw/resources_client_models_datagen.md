...
url: "https://docs.neoforged.net/docs/1.20.6/resources/client/models/datagen/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:57:56.467Z"
---
# Model Datagen

Like most JSON data, block and item models can be [datagenned](/docs/1.20.6/resources/#data-generation). Since some things are common between item and block models, so is some of the datagen code.
