...
`ModelResourceLocation` is a [client only](/docs/1.20.6/concepts/sides) class. This means that servers referencing this class will crash with a `NoClassDefFoundError`.
