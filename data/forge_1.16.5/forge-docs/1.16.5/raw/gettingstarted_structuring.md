...
chapter: "gettingstarted/structuring"
source: "https://docs.readthedocs.net/en/1.16.x/gettingstarted/structuring/"
sourceType: mkdocs
---
...
> **Important**: Important The 1.16 release brought with it a substantial change: the license field in the mods.toml is now required. If it is not provided, this is an error state. See your choices at https://choosealicense.com/
