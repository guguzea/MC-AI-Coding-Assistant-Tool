...
source: "https://docs.minecraftforge.net/en/1.16.x/gettingstarted/debugprofiler/"
sourceType: mkdocs
---
# Debug Profiler
...
> **Note**: Note Naturally, you can only profile code paths that are actually being reached. Entities and TileEntities that you want to profile must exist in the world to show up in the results.
