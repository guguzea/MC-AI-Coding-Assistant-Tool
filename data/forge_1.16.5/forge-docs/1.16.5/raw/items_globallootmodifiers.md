...
source: "https://docs.minecraftforge.net/en/1.16.x/items/globallootmodifiers/"
sourceType: mkdocs
---
...
1. Create a `global_loot_modifiers.json`. This will tell Forge about your modifiers and works similar to [tags](../../utilities/tags/).
...
4. Finally, a class that extends `GlobalLootModifierSerializer` for your operational class. This is [registered](../../concepts/registries/#registering-things) as any other `IForgeRegistryEntry`.
