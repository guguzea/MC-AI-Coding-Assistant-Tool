...
source: "https://docs.minecraftforge.net/en/1.12.x/effects/sounds/"
sourceType: mkdocs
---
# Sounds
...
In order to actually be able to play sounds, a `SoundEvent` corresponding to an entry in `sounds.json` must be created. This `SoundEvent` must then be [registered](../../concepts/registries/#registering-things). Normally, the location used to create a sound event should be set as it’s registry name.
