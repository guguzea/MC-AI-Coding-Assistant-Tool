...
source: "https://docs.minecraftforge.net/en/1.12.x/blocks/blocks/"
sourceType: mkdocs
---
# Blocks
...
- `setSoundType` - Controls the sound the block makes when it is punched, broken, or placed. Requires a `SoundType` argument, see the [sounds](../../effects/sounds/) page for more details.
