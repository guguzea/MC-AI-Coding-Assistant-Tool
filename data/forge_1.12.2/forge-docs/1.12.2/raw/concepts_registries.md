...
source: "https://docs.minecraftforge.net/en/1.12.x/concepts/registries/"
sourceType: mkdocs
---
# Registries
...
> **Note**: Note If an object is not found, either because the object itself hasn’t been registered or because the registry does not exist, a debug message is logged and the field is left unchanged.
