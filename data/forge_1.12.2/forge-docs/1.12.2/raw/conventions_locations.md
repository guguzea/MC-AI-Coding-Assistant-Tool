...
source: "https://docs.minecraftforge.net/en/1.12.x/conventions/locations/"
sourceType: mkdocs
---
# Locations
...
> **Note**: Note If a pack_format of 3 is specified in a pack.mcmeta file, the language code should be lowercase.
...
[Recipes](../../utilities/recipes/) are in JSON format and are located in `./assets/<modid>/recipes/`.