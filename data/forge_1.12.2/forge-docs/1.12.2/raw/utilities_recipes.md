...
source: "https://docs.readthedocs.net/en/1.12.x/utilities/recipes/"
sourceType: mkdocs
---
# Recipes
...
> **Note**: Note Recipe files cannot begin with an underscore as this is reserved for constants files. The JSON file extension is required.
