# Making mods with Rift

> 来源：https://github.com/DimensionalDevelopment/Rift/wiki/Making-mods-with-Rift
> 版本：1.13.2
> 抓取源：rift-wiki
> 警告：Rift GitHub wiki 是归档只读官方页，不是本地核实表。方法名以 listeners.md / 已核实源码为准。
