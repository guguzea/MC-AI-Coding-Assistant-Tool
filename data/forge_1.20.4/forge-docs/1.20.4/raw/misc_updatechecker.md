...
source: "https://docs.minecraftforge.net/en/1.20.x/misc/updatechecker/"
sourceType: mkdocs
---
...
- Forge uses an internal algorithm to determine whether one version string of your mod is “newer” than another. Most versioning schemes should be compatible, but see the `ComparableVersion` class if you are concerned about whether your scheme is supported. Adherence to [Maven versioning](../../gettingstarted/versioning/) is highly recommended.
