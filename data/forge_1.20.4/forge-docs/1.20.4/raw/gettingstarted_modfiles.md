...
source: "https://docs.minecraftforge.net/en/1.20.x/gettingstarted/modfiles/"
sourceType: mkdocs
---
# Mod Files
...
`version` | string | `"1"` | The version of the mod, preferably in a [variation of Maven versioning](../versioning/). When set to `${file.jarVersion}`, it will be replaced with the value of the `Implementation-Version` property in the JAR’s manifest (displays as `0.0NONE` in a development environment). | `"1.20-1.0.0.0"`
