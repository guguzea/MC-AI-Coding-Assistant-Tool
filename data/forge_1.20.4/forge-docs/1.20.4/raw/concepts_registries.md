...
source: "https://docs.minecraftforge.net/en/1.20.x/concepts/registries/"
sourceType: mkdocs
---
# Registries
...
> **Important**: Important Datapack Registries cannot be created with DeferredRegister. They can only be created through the event.
...
> **Important**: Important MissingMappingsEvent is fired on the Forge event bus.
