...
source: "https://docs.minecraftforge.net/en/1.13.x/blocks/interaction/"
sourceType: mkdocs
---
# Block Interaction
...
> **Important**: Important The ItemStack passed to this method is the one you should use for checking what was in the player’s hand. Grabbing the currently held stack from the player is unreliable as it may have changed since activation.
