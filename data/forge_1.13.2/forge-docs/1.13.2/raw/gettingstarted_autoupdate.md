...
source: "https://docs.readthedocs.net/en/1.13.x/gettingstarted/autoupdate/"
sourceType: mkdocs
---
...
- <li>Manually inputting data can be chore. You can configure your `build.gradle` to automatically update this file when building a release, as Groovy has native JSON parsing support. Doing this is left as an exercise to the reader.
