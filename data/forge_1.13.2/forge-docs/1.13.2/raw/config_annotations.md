...
source: "https://docs.minecraftforge.net/en/1.13.x/config/annotations/"
sourceType: mkdocs
---
# `@Config`
...
> **Note**: Note Enum config values generate a comment that is as many lines long as the enum has values.

A good example of this system is [`Forge's Test`](https://github.com/MinecraftForge/MinecraftForge/blob/603903db507a483fefd90445fd2b3bdafeb4b5e0/src/test/java/net/minecraftforge/debug/ConfigTest.java)
...
> **Important**: Important If you disable the root category, this will cause issues unless you create Sub Categories.
...
> **Note**: Note This will only work on forge version 1.12.2-14.23.1.2602 and later, as the feature was added in this update