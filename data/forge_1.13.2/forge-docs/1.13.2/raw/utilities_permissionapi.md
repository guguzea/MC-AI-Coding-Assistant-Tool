...
source: "https://docs.minecraftforge.net/en/1.13.x/utilities/permissionapi/"
sourceType: mkdocs
---
# PermissionAPI
...
> **Note**: Note The PermissionAPI isn’t restricted to be used for commands, you could also use it for other things, like restricting access to a GUI.
...
> **Note**: Note You’ve got to set the Handler during PreInit! It is also recommended to check if it wasn’t already replaced by another mod.