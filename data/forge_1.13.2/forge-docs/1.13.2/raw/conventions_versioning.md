...
source: "https://docs.minecraftforge.net/en/1.13.x/conventions/versioning/"
sourceType: mkdocs
---
# Versioning
...
`MAJORMOD`- Removing items, blocks, tile entities, etc.
...
`MINOR`- Adding items, blocks, tile entities, etc.
