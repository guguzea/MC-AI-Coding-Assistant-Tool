...
If the command fails, instead of calling sendFeedback, you may directly throw a CommandSyntaxException or `net/minecraft/command/CommandException`. See [command_exceptions](command_exceptions) for details.
