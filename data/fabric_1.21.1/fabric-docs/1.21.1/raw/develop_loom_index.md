...
> 抓取源：vitepress
> 抓取时间：2026-07-11T14:05:17.756Z
> SHA256：da8f3742569b62e99e7ca172fe7be201ebee2792f0d39ff6f0651a54e3d4cc3a
> 分支：main

# Loom 26.1.2 ​
Documentation for the Fabric Loom Gradle plugin.Fabric Loom, or just Loom for short, is a Gradle plugin for development of mods in the Fabric ecosystem.
...
IMPORTANTThis page is a reference of all options and features of Loom. If you are just getting started, please read the Introduction to Fabric.
...
- net.fabricmc.fabric-loom-companion, in advanced multi-project setups. Read more about Sub Projects
...
}123If you are using split source sets in a multi-project build, you will also need to add a dependency for the other project's client source set.
...
INFODependencies declared with include are added to remapJar in remapping Loom, or to jar in non-remapping Loom respectively. Because of this, jar tasks from other plugins (such as shadowJar) will not include these dependencies by default.
