...
platform: "neoforge"
fetchedAt: "2026-09-12T12:04:30.485Z"
---
# Ingredients

`Ingredient`s are used in [recipes](/docs/1.21.3/resources/server/recipes/) to check whether a given [ItemStack](/docs/1.21.3/items/#itemstacks) is a valid input for the recipe. For this purpose, `Ingredient` implements `Predicate<ItemStack>`, and `#test` can be called to confirm if a given `ItemStack` matches the ingredient.
