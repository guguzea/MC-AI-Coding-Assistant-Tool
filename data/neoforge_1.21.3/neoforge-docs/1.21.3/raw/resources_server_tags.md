...
platform: "neoforge"
fetchedAt: "2026-09-07T03:59:00.120Z"
---
# Tags
...
To reference tags in code, you must create a `TagKey`, where `T` is the type of tag (`Block`, `Item`, `EntityType`, etc.), using a [registry key](/docs/1.21.3/misc/resourcelocation#resourcekeys) and a [resource location](/docs/1.21.3/misc/resourcelocation):
