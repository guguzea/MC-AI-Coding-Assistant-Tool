...
url: "https://docs.neoforged.net/docs/1.21.3/resources/server/enchantments/builtin/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:58:49.782Z"
---
# Built-In Enchantment Effect Components

Vanilla Minecraft provides numerous different types of enchantment effect components for use in [enchantment](/docs/1.21.3/resources/server/enchantments/) definitions. This article will explain each, including their usage and in-code definition.
...
The object within the `value` block is a [LevelBasedValue](/docs/1.21.3/resources/server/loottables/#number-provider), which can be used to have a value effect component that changes the intensity of its effect by level.
...
- `minecraft:apply_mob_effect`: Applies a [mob effect](/docs/1.21.3/items/mobeffects) to the affected mob.
