...
url: "https://docs.neoforged.net/docs/1.21.3/gettingstarted/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:52:24.881Z"
---
...
- Open the Mod Developer Kit (MDK) (either [ModDevGradle](https://github.com/NeoForgeMDKs/MDK-1.21.3-ModDevGradle) or [NeoGradle](https://github.com/NeoForgeMDKs/MDK-1.21.3-NeoGradle)) GitHub repository, click "Use this template" and clone the newly-created repository to your local machine.
...
You should always test your mod in a dedicated server environment. This includes [client-only mods](/docs/1.21.3/concepts/sides), as these should not do anything when loaded on the server.
