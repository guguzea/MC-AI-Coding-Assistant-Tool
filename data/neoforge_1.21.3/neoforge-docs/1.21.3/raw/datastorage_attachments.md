...
*To store additional level data, you can use [SavedData](/docs/1.21.3/datastorage/saveddata).*

> **Note**
> note

Data attachments for item stacks have been superceeded by vanilla's [data components](/docs/1.21.3/items/datacomponents).
...
To sync block entity, chunk, or entity attachments to a client, you need to [send a packet to the client](/docs/1.21.3/networking/) yourself. For chunks, you can use `ChunkWatchEvent.Sent` to know when to send chunk data to a player.
