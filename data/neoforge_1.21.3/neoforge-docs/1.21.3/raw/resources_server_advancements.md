...
platform: "neoforge"
fetchedAt: "2026-06-01T10:52:45.148Z"
---
# Advancements
...
The `SimpleCriterionTrigger` implementation has two purposes: supplying a method to check trigger instances and run attached listeners on success, and specifying a [codec](/docs/1.21.3/datastorage/codecs) to serialize the trigger instance (`T`).
