...
platform: "neoforge"
fetchedAt: "2026-09-07T03:58:52.954Z"
---
...
- `entries` is a list of modifiers that should be loaded. The [ResourceLocation](/docs/1.21.3/misc/resourcelocation)s specified points to their associated entry within `data//loot_modifiers/.json`. This list is ordered, meaning that modifiers will apply in the specified order, which is sometimes relevant when mod compatibility issues occur.
