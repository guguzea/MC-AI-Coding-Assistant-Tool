...
url: "https://docs.neoforged.net/docs/1.21.3/networking/payload/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:52:54.067Z"
---
...
<li class="">The [stream codec](/docs/1.21.3/networking/streamcodecs) is used to read and write the payload to and from the buffer sent across the network</li>
...
With your own payloads you can then use those to configure the client and server using [Configuration Tasks](/docs/1.21.3/networking/configuration-tasks).
