...
platform: "neoforge"
fetchedAt: "2026-09-12T12:04:18.145Z"
---
# Enchantments
...
Enchantment JSON files can be created automatically using the [data generation](/docs/1.21.3/resources/#data-generation) system by passing a `RegistrySetBuilder` into `DatapackBuiltInEntriesProvider`. The JSON will be placed in `<project root>/src/generated/data/<modid>/enchantment/<path>.json`.
