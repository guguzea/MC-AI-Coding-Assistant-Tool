...
url: "https://docs.neoforged.net/docs/1.21.3/datastorage/saveddata/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:58:29.707Z"
---
# Saved Data

The Saved Data (SD) system can be used to save additional data on levels.

*If the data is specific to some block entities, chunks, or entities, consider using a [data attachment](/docs/1.21.3/datastorage/attachments) instead.*
