---
title: "NeoForge Primer 1.21.6 -> 1.21.7"
primerKey: "1.21.7"
from: "1.21.6"
to: "1.21.7"
url: "https://docs.neoforged.net/primer/docs/1.21.7/"
platform: "neoforge"
type: "primer"
fetchedAt: "2026-06-01T10:56:25.792Z"
---
...
<li class="">`net.minecraft.client.renderer.RenderPipelines#GUI_TEXT_HIGHLIGHT` now uses the `ADDITIVE` blend function instead of the `OR_REVERSE` color logic</li>
<li class="">`net.minecraft.client.renderer.item.ItemStackRenderState#getModelIdentity` -> `TrackingItemRenderState#getModelIdentity`</li>
</ul>
