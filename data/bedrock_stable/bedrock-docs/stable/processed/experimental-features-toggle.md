...
Experimental Features in Minecraft: Bedrock Edition | Microsoft Learn
 ...
 Drop 2 2025
 Experience flying with the Happy Ghast, coming in the second game drop of 2025
 Locator Bar
 ...
 Enables custom components V2 for scripting (V2.0.0-beta and higher) and JSON (V1.21.80 and higher) APIs
