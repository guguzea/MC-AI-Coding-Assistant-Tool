...
Type: PlayerCraftRecipeAfterEventSignal
...
This event fires when a @minecraft/server.WorldClock is paused.

Type: WorldClockOnPausedAfterEventSignal
...
This event fires when a @minecraft/server.WorldClock is resumed.

Type: WorldClockOnResumedAfterEventSignal
...
This event fires when the time of a @minecraft/server.WorldClock hits a @minecraft/server.TimeMarker on the clock. This can happen during a regular level tick or when the time is set.

Type: WorldClockOnTimeMarkerAfterEventSignal
...
This event fires when a @minecraft/server.WorldClock time is changed. This can happen when the time is directly set through scripts or commands or when the clock reaches the maximum time and restarts.

Type: WorldClockOnTimeModifiedAfterEventSignal
