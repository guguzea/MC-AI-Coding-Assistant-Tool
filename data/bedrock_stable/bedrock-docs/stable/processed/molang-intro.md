...
- In the context of how a cow can reward a player with experience points, there are two ways feed wheat to two cows so they breed a baby cow ( "on_bred" ), or when you
...
- Upon the death of a cow: Run a query to see who was the last player to hit it.
