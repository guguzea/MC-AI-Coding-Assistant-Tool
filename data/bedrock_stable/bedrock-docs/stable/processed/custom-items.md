...
- Go into your world and use the /give @s demo: command to get your custom item.
...
- Edit minecraft:icon : ```json "minecraft:icon": { "textures": { "default": "custom_chestplate_icon", "dyed": "custom_chestplate_icon_gray" } }, ```

- Add minecraft:dyeable . ```json "minecraft:dyeable": { "default_color": "#175882" } ```
...
- Edit render_controllers like this... ```json "render_controllers": [ "controller.render.custom_chestplate" ], ```

- Edit materials to be: ```json "materials": { "default": "armor", "dyed": "entity_alphatest_change_color" }, ```

- Edit textures to be: ```json "textures": { "default": "textures/items/custom_chestplate.png", "dyed": "textures/items/custom_chestplate_grayscale.tga" }, ```

- Add scripts: ```json "scripts": { "pre_animation": [ "variable.is_dyed = query.armor_color_slot(1, 0) != 1.0 || query.armor_color_slot(1, 1) != 1.0 || query.armor_color_slot(1, 2) != 1.0" ] } ```
