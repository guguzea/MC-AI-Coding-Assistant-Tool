> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/bedrockeditor/editorcameratool?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:50:27.942Z
> 警告：此文档可能滞后于当前正式版
...
- Select Camera by clicking the button in the tool rail on the left side of the Editor.

- Navigate to the starting position for your camera path and click + to add the first control point.

- Move to subsequent positions, adding control points along the desired path.

- Adjust the Spline Type , Total Duration , and individual control point settings as needed.

- Click Preview Animation to preview the camera path.

- Click Export Code to generate a script you can use in your add-on.
