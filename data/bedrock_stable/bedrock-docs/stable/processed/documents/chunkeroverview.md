> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/chunkeroverview?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:50:32.719Z
> 警告：此文档可能滞后于当前正式版
...
For this tutorial, we'll be working with the app version. Instructions for how to use the CLI version can be found here .
...
More information on "Advanced Mode" and the features within it can be found in the advanced mode tutorial.
...
Click the Save button to save your converted world in the selected Output folder. If you want to distribute your converted world, you can upload it to a service such as OneDrive and share it.
