> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/convertingtexturepacks?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:36.854Z
> 警告：此文档可能滞后于当前正式版
...
- The metadata files ( .json ).
 ...
 Animation
 Block animations controlled by `flipbook_textures.json`, can be customized

 Spawn Egg
 Individual spawn egg textures

 Potion bottle
 Individual potion bottles

 Color maps
 `.json` file

 Transparency or emissive
 `.tga` file with alpha channel `.png` for items
 ...
 Geometry
 Custom mob geometry, UVs
 Geometry can be updated with programs such as Blockbench or Blender
...
## Packaging Changes
 ...
 Java Edition textures folder subdirectories
 Bedrock Edition textures folder subdirectories
 ...
 Sample Java Edition texture filenames
 Sample Bedrock Edition texture filenames
