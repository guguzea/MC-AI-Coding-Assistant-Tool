> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/update1.26.0?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:17.898Z
> 警告：此文档可能滞后于当前正式版
...
- regular_skip_data - Used during normal skip movement distance_scale - Multiplier applied to horizontal velocity when jumping
...
`minecraft://connect?localLevelId= ` launch protocol now requires the level id to be a URL encoded value.
