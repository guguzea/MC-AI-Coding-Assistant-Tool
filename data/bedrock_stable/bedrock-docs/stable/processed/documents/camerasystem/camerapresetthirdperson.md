> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/camerasystem/camerapresetthirdperson?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:56.996Z
> 警告：此文档可能滞后于当前正式版
...
You can find more information about the camera system in the Camera System Introduction and in the Free Camera Preset tutorial, using commands and script.
...
- Rotation : Sets the degree to which the camera can rotate around the player. Yaw : Sets the rotation of the camera 360 degrees around the target parallel to the earth. The yaw value can be up to 180 to point directly to the right, and up to -180 to point directly to the left.
