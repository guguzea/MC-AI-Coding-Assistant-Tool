> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/scripting/components-tutorial?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:44.343Z
> 警告：此文档可能滞后于当前正式版
...
There are a variety of components built into Minecraft, with various parameters used to control their behavior. With custom components , you can define your own behavior for blocks and items through scripting!
...
In addition, it'll be helpful to know how to make blocks and items in your add-on. (Our sample source code provides textures for the strawberries!) Read Creating a Custom Die Block for information on making your own.
...
### Adding custom components to items
 ...
 Scripting V2.0.0 changes and simplifies this process, as well as giving custom components a few new special powers, and this tutorial uses V2.0.0. Read the overview for more information!
