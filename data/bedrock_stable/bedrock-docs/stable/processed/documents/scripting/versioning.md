> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/scripting/versioning?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:47.727Z
> 警告：此文档可能滞后于当前正式版
...
Also, as of 1.21.70 previews, we've also introduced 2.0.0-beta versions of scripting APIs. See the Scripting V2 Overview for more about the changes in Version 2.
...
For the definitive resource on APIs and types that are exposed in various versions, consider using the type definitions available through npm at npmjs.com . The @minecraft/server definitions contain different variants of type definitions for stable and beta tracks, as well as across both main and preview releases of Minecraft Bedrock Edition. See more on how to use these type definitions in the Developer Tools article .
