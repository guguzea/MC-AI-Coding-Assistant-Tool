> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/scripting/error-handling?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:47.084Z
> 警告：此文档可能滞后于当前正式版
...
If you're going to use this pattern extensively in your code, consider creating a wrapping function. This lets you add the `try-catch` construct to any function without modifying it—you pass the function you want to wrap into your wrapping function as a parameter. Here's an example:
...
```typescript
async function loadPlayerData(player: Player): Promise
 {
 try {
