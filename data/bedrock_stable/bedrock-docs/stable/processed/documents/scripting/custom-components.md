> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/scripting/custom-components?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:44.111Z
> 警告：此文档可能滞后于当前正式版
...
Custom components are even more powerful in Scripting Version 2.0.0 ! This tutorial describes Custom Components Version 2, introduced along with Scripting Version 2.

## Structure

This new feature is named custom components because scripts are connected to a given block or item's JSON in a manner very similar to attaching to one of the built-in Minecraft components. As such, there is both a JSON aspect and a script aspect to the feature.
...
To find out more about the Custom Component APIs, see the documentation for the ItemCustomComponent and BlockCustomComponent APIs.
