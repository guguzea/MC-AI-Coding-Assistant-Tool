> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/commandsdamageintroduction?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:41.980Z
> 警告：此文档可能滞后于当前正式版
...
- damager is a selector that must evaluate to one entity. It determines which entity will be treated as dealing the damage to the target. For example, a damaged zombified piglin will get angry at this entity. If specified, the target will also take knockback such that they are pushed away from the damager, no matter the distance between the two entities.
...
If the affected entity has a `damage_sensor` component, the damage dealt by this command will activate it when applicable. The presence or absence of this behavior on vanilla mobs may make some situations unintuitive. Here are a few examples:
