> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/customblockrenderlighting?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:50:17.523Z
> 警告：此文档可能滞后于当前正式版
...
You can create your own transparent block, or check out the minecraft-samples page for more information.
...
- Export the file in Blockbench just as we did for the sushi block.

- Add the downloaded geometry file by navigating to custom_block_resource_pack/models/blocks and copying the file in.
...
- Add the bubble fish texture in the custom_block_resource_pack/textures/blocks folder.

- Add a friendly name in terrain_texture.json by navigating to custom_block_resource_pack/textures and editing the terrain_texture.json file.

- Navigate to custom_block_resource_pack/texts/en_US.lang and add a localized named for the bubble fish.

- Finally, you can add an entry to blocks.json to give this block a sound. Remember, if you are using custom geometry and materials an entry in blocks.json is completely optional, so we did not add one for this block.
