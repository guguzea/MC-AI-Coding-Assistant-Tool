> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/update1.26.10?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:16.576Z
> 警告：此文档可能滞后于当前正式版
...
- The simulate_waves field has been replaced with movement_type , which accepts: "waves" — moves up and down based on speed (default)
...
## Editor
 ...
 Editor continues to receive significant updates in this release, spanning Releases 1.2.5 through 1.3.0. For detailed release notes, see the Editor GitHub Discussions for Release 1.2.5 , Release 1.2.6 , Release 1.2.7 , Release 1.2.8 , and Release 1.3.0 .
...
- CustomForm.show() returns Promise (true = shown, false = not shown)
...
- createTickingArea() now returns Promise instead of Promise
