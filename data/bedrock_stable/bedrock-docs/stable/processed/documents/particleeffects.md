> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/particleeffects?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:50:06.977Z
> 警告：此文档可能滞后于当前正式版
...
You'll also use Snowstorm - a community tool that will make editing particle effects much easier!
...
If using the VSCode extension, create a new file named ` .particle.json` in the particles folder, and VSCode will open it with the Snowstorm editor automatically. Clicking Open Code in the top right corner will preview the generated code in a new tab, and the code can be edited here directly as well.
