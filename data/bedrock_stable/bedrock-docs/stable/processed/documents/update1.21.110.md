> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/update1.21.110?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:18.595Z
> 警告：此文档可能滞后于当前正式版
...
- Aim assist - Now available for use with projectiles.

## World Gen

Custom Biomes are now available!

- Biome Replacement - The ability to replace Vanilla biomes with custom biome configurations.

## Items

- Item inventory components - Allows for items to have an inventory like a container (as with bundles). storage_item
...
- Player Velocity APIs Player.applyImpulse

- Player.clearVeolocity

- Book APIs ItemBookComponent
