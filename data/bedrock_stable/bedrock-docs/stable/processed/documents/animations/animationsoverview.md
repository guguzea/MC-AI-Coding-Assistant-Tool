> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/animations/animationsoverview?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:50:01.659Z
> 警告：此文档可能滞后于当前正式版
...
The Animations vs. Animation Controllers article goes over the difference between animations and animation controllers in much greater depth.
...
To learn more about Animation Controllers, please visit the Animation Controllers reference page.
...
- From 0 to 0.5 seconds (in the "pre" tag), the head bone is set to a scale of 1 in all dimensions [X, Y, Z]

- At 0.5 seconds, the bone will instantly scale up to 2 times its normal size

- From 0.5 to 1 second ("post"), the bone will re-scale back to the scale of 1 in all dimensions
