> 来源：https://learn.microsoft.com/en-us/minecraft/creator/documents/preparingrawtextforlocalization?view=minecraft-bedrock-stable
> 抓取时间：2026-09-21T11:49:37.622Z
> 警告：此文档可能滞后于当前正式版
...
- String Comment (highly recommended)
...
```json
Author.Name.2=Created by ### is the proper name of the map creator, and he is a male person.
```

The comment, ` is the proper name of the map creator, and he is a male person`, is shown to the translator while they are translating the text, `Created by `. Notice how the comment specifies that the person's name is a singular male proper name. This is a good practice, because translations in some languages are different depending on whether the context is a singular person (including their gender), a group of people, or a company name.
...
- Context and parts-of-speech

- Proper names (with descriptions)

- Subject/object gender, number, and whether it's a place/location

- Meanings of characters and items

- The intent of color codes

- Any parts that should not be translated

- The full text of any split or concatenated lines (see below)
