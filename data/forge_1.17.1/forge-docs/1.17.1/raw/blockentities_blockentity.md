...
source: "https://docs.minecraftforge.net/en/1.17.x/blockentities/blockentity/"
sourceType: mkdocs
---
# BlockEntities
...
> **Note**: Note BlockEntities aren’t a solution for everything and they can cause lag when used wrongly. When possible, try to avoid them.
...
> **Note**: Note This method is called each tick; therefore, you should avoid having complicated calculations in here. If possible, you should make more complex calculations every X ticks. (The amount of ticks in a second may be lower then 20 (twenty) but won’t be higher)
...
while the second one processes that data. If your `BlockEntity` doesn’t contain much data, you might be able to use the methods out of the [Storing Data within your `BlockEntity`](#storing-data-within-your-blockentity) section.
