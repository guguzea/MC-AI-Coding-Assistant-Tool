...
source: "https://docs.minecraftforge.net/en/1.14.x/utilities/recipes/"
sourceType: mkdocs
---
# Recipes

With the update to Minecraft 1.12, Mojang introduced a new data-driven recipe system based on JSON files. Since then it has been adopted by Forge as well and was expanded in Minecraft 1.13 into [datapacks](datapacks.md).
