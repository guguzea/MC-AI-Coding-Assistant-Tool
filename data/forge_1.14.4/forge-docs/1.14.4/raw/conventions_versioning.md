...
source: "https://docs.readthedocs.net/en/1.14.x/conventions/versioning/"
sourceType: mkdocs
---
# Versioning
...
<li>`MAJORMOD`- <li>Removing items, blocks, tile entities, etc.
...
<li>`MINOR`- <li>Adding items, blocks, tile entities, etc.
