...
source: "https://docs.minecraftforge.net/en/1.14.x/models/advanced/perspective/"
sourceType: mkdocs
---
# Perspective
...
This enum is also patched to implement [`IModelPart`](imodelstate+part.md). This allows `IModelState`s to alter the perspective handling of models. However, the model itself must implement this behavior. (See [below](#gettransforms).)
