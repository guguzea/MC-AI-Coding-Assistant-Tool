...
source: "https://docs.minecraftforge.net/en/1.14.x/conventions/locations/"
sourceType: mkdocs
---
# Locations
...
[Localizations](../../concepts/internationalization/) are plain-text files with the file extension `.json` and the name being their [language code](https://msdn.microsoft.com/en-us/library/ee825488(v=cs.20).aspx) in lowercase such as `en_us`.
...
[Recipes](../../utilities/recipes/) are in JSON format and are located in `./data/<modid>/recipes/`.