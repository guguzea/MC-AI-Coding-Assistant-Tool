...
source: "https://docs.readthedocs.net/en/1.14.x/gettingstarted/structuring/"
sourceType: mkdocs
---
...
> **Important**: Important If you do not own a domain, do not use it for your top level package. It is perfectly acceptable to start your package with anything, such as your name/nickname, or the name of the mod.
...
<a name="version-ranges" style="color: inherit; text-decoration: inherit">* All version ranges use the [Maven Version Range Specification](https://maven.apache.org/enforcer/enforcer-rules/versionRanges.html).
