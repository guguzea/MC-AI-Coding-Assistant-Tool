...
source: "https://docs.minecraftforge.net/en/1.14.x/datagen/intro/"
sourceType: mkdocs
---
# Data Generators
...
Data providers are the classes that actually define what data will be generated and provided. All data providers implement `IDataProvider`. Minecraft has abstract implementations for most assets and data, so modders need only to extend and override the specified method.
...
> **Note**: Notes An AdvancementProvider class does exists, however it is hardcoded for only the vanilla advancements.