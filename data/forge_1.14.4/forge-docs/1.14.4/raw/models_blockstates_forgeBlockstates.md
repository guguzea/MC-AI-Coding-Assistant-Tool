...
source: "https://docs.minecraftforge.net/en/1.14.x/models/blockstates/forgeBlockstates/"
sourceType: mkdocs
---
> **Warning**: Warning This feature is deprecated and has been removed from Forge in 1.15+.
...
> **Attention**: Attention Note that all models and textures referenced are from vanilla minecraft. For your own mod, you have to use the full location! For example: "mymod:blocks/blockTexture". You don’t have to use Forge’s blockstate format at all, you can also use the vanilla format!
...
> **Note**: Note Notice here that the string used in the json is lowercase. It has to be lowercase or it won’t be found.
