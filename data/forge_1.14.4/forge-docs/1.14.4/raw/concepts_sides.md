...
source: "https://docs.readthedocs.net/en/1.14.x/concepts/sides/"
sourceType: mkdocs
---
# Sides in Minecraft
...
When we say &ldquo;client&rdquo; or &ldquo;server&rdquo;, it usually follows with a fairly intuitive understanding of what part of the game we&rsquo;re talking about. After all, a client is what the user interacts with, and a server is where the user connects for a multiplayer game. Easy, right?
