...
platform: "neoforge"
fetchedAt: "2026-06-01T10:55:33.158Z"
---
# Data Attachments
...
*To store additional level data, you can use [SavedData](/docs/1.20.4/datastorage/saveddata).*
...
To sync block entity, chunk, or entity attachments to a client, you need to [send a packet to the client](/docs/1.20.4/networking/) yourself.
