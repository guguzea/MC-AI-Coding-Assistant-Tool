...
url: "https://docs.neoforged.net/docs/1.20.4/datastorage/nbt/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:56:56.677Z"
---
...
Minecraft uses `.nbt` files extensively, for example for structure files in [datapacks](/docs/1.20.4/resources/server/). Region files (`.mca`) that contain the contents of a region (i.e. a collection of chunks), as well as the various `.dat` files used in different places by the game, are NBT files as well.
...
NBT is used in a lot of places in Minecraft. Some of the most common examples include [ItemStack](/docs/1.20.4/items/#itemstacks)s, [BlockEntity](/docs/1.20.4/blockentities/)s and `Entity`s.
