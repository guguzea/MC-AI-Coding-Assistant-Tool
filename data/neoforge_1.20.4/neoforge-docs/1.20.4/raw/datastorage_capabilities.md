...
A capability *provider* is what ultimately supplies a capability.
...
Refer to the [invalidation section](#block-capability-invalidation) above for more information.
