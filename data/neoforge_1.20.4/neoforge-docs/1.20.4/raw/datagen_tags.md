...
version: "1.20.4"
pageId: "datagen/tags"
url: "https://docs.neoforged.net/docs/1.20.4/datagen/tags/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:56:53.161Z"
---
# Tag Generation

[Tags](/docs/1.20.4/resources/server/tags) can be generated for a mod by subclassing `TagsProvider` and implementing `#addTags`. After implementation, the provider must be [added](/docs/1.20.4/resources/#data-generation) to the `DataGenerator`.
