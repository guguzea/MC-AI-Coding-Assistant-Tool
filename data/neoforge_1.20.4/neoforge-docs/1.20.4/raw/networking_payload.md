...
url: "https://docs.neoforged.net/docs/1.20.4/networking/payload/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:00:17.090Z"
---
...
<li class="">The constructor of `MyData` is used as a method reference to create a reader for the payload.</li>
<li class="">The third argument for the registration method is a callback that can be used to register the handlers for when the payload arrives at either the client or server side.<!-- -->
...
With your own payloads you can then use those to configure the client and server using [Configuration Tasks](/docs/1.20.4/networking/configuration-tasks)
