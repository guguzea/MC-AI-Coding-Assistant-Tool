...
url: "https://docs.neoforged.net/docs/1.20.4/resources/server/recipes/custom/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:57:16.647Z"
---
# Custom Recipes
...
If none of the existing types match what context the recipe will be used within, then a new `RecipeType` must be [registered](/docs/1.20.4/concepts/registries#methods-for-registering).
...
All custom recipes, regardless of input or output data, can be created into a `FinishedRecipe` for [data generation](/docs/1.20.4/datagen/recipes#custom-recipe-serializers) using the `RecipeProvider`.
