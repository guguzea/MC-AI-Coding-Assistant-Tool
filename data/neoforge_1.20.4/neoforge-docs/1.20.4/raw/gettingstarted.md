...
url: "https://docs.neoforged.net/docs/1.20.4/gettingstarted/"
platform: "neoforge"
fetchedAt: "2026-08-06T04:46:06.880Z"
---
...
- An installation of the Java 17 Development Kit (JDK) and 64-bit Java Virtual Machine (JVM). NeoForge recommends and officially supports the [Microsoft builds of OpenJDK](https://learn.microsoft.com/en-us/java/openjdk/download#openjdk-17), but any other JDK should work as well.
...
- Open the [Mod Developer Kit (MDK)](https://github.com/NeoForgeMDKs/MDK-1.20.4-NeoGradle) GitHub repository, click "Use this template" and clone the newly-created repository to your local machine.
...
<li class="">Open your IDE and import the Gradle project. Eclipse and IntelliJ IDEA will do this automatically for you. If you have an IDE that does not do this, you can also do it via the `gradlew` terminal command.<!-- -->
...
You should always test your mod in a dedicated server environment. This includes [client-only mods](/docs/1.20.4/concepts/sides), as these should not do anything when loaded on the server.
