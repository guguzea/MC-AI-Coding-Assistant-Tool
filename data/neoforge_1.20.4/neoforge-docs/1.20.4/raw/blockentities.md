...
url: "https://docs.neoforged.net/docs/1.20.4/blockentities/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:54:34.150Z"
---
# Block Entities
...
You should first check out the [Networking](/docs/1.20.4/networking/) section and especially [PayloadRegistrar](/docs/1.20.4/networking/payload) before attempting this.
