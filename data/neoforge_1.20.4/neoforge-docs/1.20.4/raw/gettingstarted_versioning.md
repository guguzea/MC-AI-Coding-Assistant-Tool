...
platform: "neoforge"
fetchedAt: "2026-09-12T11:59:41.029Z"
---
# Versioning
...
A few places in NeoForge also use [Maven version ranges](https://maven.apache.org/enforcer/enforcer-rules/versionRanges.html), for example the Minecraft and NeoForge version ranges in the [mods.toml](/docs/1.20.4/gettingstarted/modfiles#modstoml) file. These are mostly, but not fully compatible with semver (the `pre`-tag is not considered by it, for example).
