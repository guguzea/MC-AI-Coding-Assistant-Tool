...
version: "1.19.4"
forgeVersion: "45.2.0"
chapter: "resources/server/glm"
source: "https://docs.minecraftforge.net/en/1.19.x/resources/server/glm/"
sourceType: mkdocs
---
...
4. <li>Finally, a codec to encode and decode your operational class.- <li>This is [registered](../../../concepts/registries/#methods-for-registering) as any other `IForgeRegistryEntry`.
...
The connector between the JSON and the `IGlobalLootModifier` instance is a [`Codec<T>`](../../../datastorage/codecs/), where `T` represents the type of the `IGlobalLootModifier` to use.

For ease of convenience, a loot conditions codec has been provided for an easy addition to a record-like codec via `LootModifier#codecStart`. This is utilized for [data generation](../../../datagen/server/glm/) of the associated loot modifier.
...
[Examples](https://github.com/MinecraftForge/MinecraftForge/blob/1.19.x/src/test/java/net/minecraftforge/debug/gameplay/loot/GlobalLootModifiersTest.java) can be found on the Forge Git repository, including silk touch and smelting effects.