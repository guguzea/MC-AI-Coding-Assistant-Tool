...
forgeVersion: "45.2.0"
chapter: "datagen"
source: "https://docs.minecraftforge.net/en/1.19.x/datagen/"
sourceType: mkdocs
---
# Data Generators
...
- [`net.minecraftforge.client.model.generators.ModelProvider<?>`](client/modelproviders/) - for [models](../resources/client/models/); implement `#registerModels` [`ItemModelProvider`](client/modelproviders/#itemmodelprovider) - for item models
- [`BlockModelProvider`](client/modelproviders/#blockmodelprovider) - for block models

[`net.minecraftforge.client.model.generators.BlockStateProvider`](client/modelproviders/#block-state-provider) - for blockstate JSONs and their block and item models; implement `#registerStatesAndModels`
