...
source: "https://docs.readthedocs.net/en/1.19.x/blockentities/ber/"
sourceType: mkdocs
---
# BlockEntityRenderer
...
To create a BER, create a class that inherits from `BlockEntityRenderer`. It takes a generic argument specifying the block&rsquo;s `BlockEntity` class. The generic argument is used in the BER&rsquo;s `render` method.
