...
source: "https://docs.minecraftforge.net/en/1.19.x/misc/gametest/"
sourceType: mkdocs
---
# Game Tests
...
> **Tip**: Tip The local variable generated by /test pos can specify its reference name by appending it to the end of the command: /test pos  # Exports 'final BlockPos  = new BlockPos(...);'
...
> **Note**: Note Subcommands follow the test command: /test .
