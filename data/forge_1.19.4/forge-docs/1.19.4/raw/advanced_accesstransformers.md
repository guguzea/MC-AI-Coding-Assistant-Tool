...
source: "https://docs.readthedocs.net/en/1.19.x/advanced/accesstransformers/"
sourceType: mkdocs
---
# Access Transformers
...
- <li>Example: `Ljava/lang/String;` refers to `java.lang.String` reference type _*(note the use of slashes instead of periods)*_
