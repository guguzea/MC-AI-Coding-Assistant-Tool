...
forgeVersion: "45.2.0"
chapter: "items"
source: "https://docs.minecraftforge.net/en/1.19.x/items/"
sourceType: mkdocs
---
# Items
...
An item can be added to a `CreativeModeTab` via `CreativeModeTabEvent$BuildContents` on the [mod event bus](../concepts/events/#mod-event-bus). Items can be added without any additional configurations via `#accept`.
