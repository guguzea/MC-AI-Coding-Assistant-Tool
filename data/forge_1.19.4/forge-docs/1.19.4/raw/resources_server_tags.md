...
source: "https://docs.minecraftforge.net/en/1.19.x/resources/server/tags/"
sourceType: mkdocs
---
# Tags
...
> **Note**: Note Intrusive Holders may be removed in a future version of Minecraft. If they are, the below methods can be used instead to query the associated Holders.
...
- <li>If there is a Forge tag that fits your block or item, add it to that tag. The list of tags declared by Forge can be seen on [GitHub](https://github.com/MinecraftForge/MinecraftForge/tree/1.19.x/src/generated/resources/data/forge/tags).
