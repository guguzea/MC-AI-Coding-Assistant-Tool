...
> 来源：https://www.liteloader.com/explore/docs/user:install:manual:1.7.10
> 版本：1.10.2
> 页面 ID：user:install:manual:1.7.10
> 抓取源：liteloader-wiki
...
*These instructions are for third-party launcher, for instructions for the real launcher [click here](.:1.7.10:vanilla)*.
