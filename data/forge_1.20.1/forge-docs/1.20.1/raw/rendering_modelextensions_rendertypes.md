...
- `minecraft:solid`<ul> <li>Chunk render type: `RenderType#solid()`
- Entity render type: `ForgeRenderTypes#ITEM_LAYERED_SOLID`
- Used for fully solid blocks (i.e. Stone)

<li>`minecraft:cutout`- Chunk render type: `RenderType#cutout()`
...
<li>`minecraft:cutout_mipped`- Chunk render type: `RenderType#cutoutMipped()`
- Entity render type: `ForgeRenderTypes#ITEM_LAYERED_CUTOUT`
...
<li>`minecraft:cutout_mipped_all`- Chunk render type: `RenderType#cutoutMipped()`
...
<li>`minecraft:translucent`- Chunk render type: `RenderType#translucent()`
...
<li>`minecraft:tripwire`- Chunk render type: `RenderType#tripwire()`
- Entity render type: `ForgeRenderTypes#ITEM_LAYERED_TRANSLUCENT`
