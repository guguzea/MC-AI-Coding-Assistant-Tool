...
source: "https://docs.minecraftforge.net/en/1.20.1/gettingstarted/structuring/"
sourceType: mkdocs
---
...
> **Note**: Note You do not have to follow the advice below; you can structure your mod any way you see fit. However, it is still highly recommended to do so.
...
> **Note**: Note Mojang typically follows a similar structure for all classes except entities. Those are represented by just their names (e.g. Pig, Zombie, etc.).
