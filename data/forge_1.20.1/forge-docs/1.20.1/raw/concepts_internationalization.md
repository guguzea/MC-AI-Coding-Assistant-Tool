...
version: "1.20.1"
forgeVersion: "47.2.0"
chapter: "concepts/internationalization"
source: "https://docs.readthedocs.net/en/1.20.1/concepts/internationalization/"
sourceType: mkdocs
---
...
- <li><code>get(String, Object...)` localizes in the client&rsquo;s locale with formatting. The first parameter is a translation key, and the rest are formatting arguments for `String.format(String, Object...)`.
