...
> 来源：https://docs.minecraftforge.net/en/1.20.1/rendering/modelextensions/facedata
> 版本：1.20.1
...
The additional data can be specified in the two ways shown in this example: ```json { "elements": [ { "forge_data": { "color": "0xFFFF0000", "block_light": 15, "sky_light": 15, "ambient_occlusion": false }, "faces": { "north": { "forge_data": { "color": "0xFFFF0000", "block_light": 15, "sky_light": 15, "ambient_occlusion": false }, // ... }, // ... }, // ... } ] } ```
...
In the following example, layer 1 will be tinted red and glow at full brightness: ```json { "textures": { "layer0": "minecraft:item/stick", "layer1": "minecraft:item/glowstone_dust" }, "forge_data": { "1": { "color": "0xFFFF0000", "block_light": 15, "sky_light": 15, "ambient_occlusion": false } } } ```
