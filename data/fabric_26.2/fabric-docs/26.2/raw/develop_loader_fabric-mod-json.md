...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/26.2/develop/loader/fabric-mod-json.md
> 版本：26.2
> GitHub 路径：develop/loader/fabric-mod-json.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-10T15:17:02.911Z
> SHA256：01813492a8adefadadffcd56795d3aed4e9cd54f511283f8c366ac9b99642d91
> 分支：main
...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | ------------------------------ |
| <Range r="*" />            | Any version (not recommended)                                                                                                                | `26.2`, `24w14potato`...                  | _none_                         |
| <Range r="26.2" />       | Exact version only                                                                                                                           | `26.2`                                    | `26.1`, `26.1.1`, `26.2`...    |
| <Range r=">26" />          | Above a version (exclusive)                                                                                                                  | `26.2`, `26.2`...                         | `26`, `25.x`...                |
| <Range r=">=26.1" />       | At or above a version (inclusive)                                                                                                            | `26.1`, `26.2`, `26.2`...                 | `26.0`, `25.x`...              |
| <Range r="<=26.1" />       | At or below a version (inclusive)                                                                                                            | `26.1`, `26.0`, `25.x`...                   | `26.2`, `26.2`...            |
| <Range r=">26 <26.2" />    | Between two versions (both exclusive)                                                                                                        | `26.1`, `26.2`, snapshots...              | `26`, `26.2`...                |
| <Range r=">=26.1 <26.2" /> | Between two versions (inclusive lower bound)                                                                                                 | `26.1`, `26.2`, snapshots...              | `26.0`, `26.2`...              |
| <Range r="~26.1-rc.2" />   | Same to next minor version, excluding earlier versions (equivalent to `>=26.1-rc.2 <26.2-`). Only checks the `major` and `minor` components. | `26.1-rc.2`, `26.1`, `26.2`, snapshots... | `26.1-rc.1`, `26.2`, `27.x`... |
...
| <Range r="26.1.x" />       | Equivalent to `~26.1-`.                                                                                                                      | `26.1-rc-3`, `26.1`, `26.2`, snapshots... | `26.2`, `27.x`...              |
