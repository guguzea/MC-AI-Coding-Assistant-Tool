...
platform: "neoforge"
fetchedAt: "2026-06-01T10:53:28.173Z"
---
# Advancements
...
The `SimpleCriterionTrigger` implementation has two purposes: supplying a method to check trigger instances and run attached listeners on success, and specifying a [codec](/docs/1.21.1/datastorage/codecs) to serialize the trigger instance (`T`).
