...
platform: "neoforge"
fetchedAt: "2026-09-12T12:02:14.212Z"
---
# Data Attachments

The data attachment system allows mods to attach and store additional data on block entities, chunks, and entities.

*To store additional level data, you can use [SavedData](/docs/1.21.1/datastorage/saveddata).*

> **Note**
> note

Data attachments for item stacks have been superceeded by vanilla's [data components](/docs/1.21.1/items/datacomponents).
...
To sync block entity, chunk, or entity attachments to a client, you need to [send a packet to the client](/docs/1.21.1/networking/) yourself. For chunks, you can use `ChunkWatchEvent.Sent` to know when to send chunk data to a player.
