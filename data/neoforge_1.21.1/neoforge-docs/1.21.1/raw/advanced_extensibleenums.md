...
platform: "neoforge"
fetchedAt: "2026-09-07T03:53:11.274Z"
---
# Extensible Enums
...
<li class="">If the enum has constructors which are not usable by mods (i.e. because they require registry objects on an enum that may be initialized before modded registration runs), then they should be annotated with `@ReservedConstructor`</li>
</ul>
