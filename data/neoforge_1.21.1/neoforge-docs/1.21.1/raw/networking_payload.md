...
platform: "neoforge"
fetchedAt: "2026-06-01T10:53:35.586Z"
---
...
<li class="">The [stream codec](/docs/1.21.1/networking/streamcodecs) is used to read and write the payload to and from the buffer sent across the network</li>
...
With your own payloads you can then use those to configure the client and server using [Configuration Tasks](/docs/1.21.1/networking/configuration-tasks).
