...
platform: "neoforge"
fetchedAt: "2026-09-12T12:02:16.301Z"
---
# Saved Data

The Saved Data (SD) system can be used to save additional data on levels.

*If the data is specific to some block entities, chunks, or entities, consider using a [data attachment](/docs/1.21.1/datastorage/attachments) instead.*
