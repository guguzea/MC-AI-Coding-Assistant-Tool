...
platform: "neoforge"
fetchedAt: "2026-09-07T03:53:25.499Z"
---
# Model Datagen

Like most JSON data, block and item models can be [datagenned](/docs/1.21.1/resources/#data-generation). Since some things are common between item and block models, so is some of the datagen code.
