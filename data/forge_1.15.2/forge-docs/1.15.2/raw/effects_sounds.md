...
source: "https://docs.readthedocs.net/en/1.15.x/effects/sounds/"
sourceType: mkdocs
---
# Sounds
...
1. <li><a name="clientworld-playsound-becvpd"> <code>playSound(BlockPos, SoundEvent, SoundCategory, volume, pitch, distanceDelay)`- <li>Simply forwards to `World`&rsquo;s [overload (3)](#world-playsound-xyzecvpd), adding 0.5 to each coordinate of the `BlockPos` given.
