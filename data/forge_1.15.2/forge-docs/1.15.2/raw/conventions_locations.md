...
source: "https://docs.minecraftforge.net/en/1.15.x/conventions/locations/"
sourceType: mkdocs
---
# Locations
...
[Localizations](../../concepts/internationalization/) are JSONs named after their lowercased [language code](https://msdn.microsoft.com/en-us/library/ee825488(v=cs.20).aspx), such as `en_us`.
...
[Recipes](../../utilities/recipes/) are JSONs located within `./data/<modid>/recipes/`.