...
url: "https://docs.neoforged.net/docs/1.21.5/datastorage/attachments/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:59:09.878Z"
---
# Data Attachments

The data attachment system allows mods to attach and store additional data on block entities, chunks, entities, and levels.

*To store additional level data, you can use [SavedData](/docs/1.21.5/datastorage/saveddata).*

> **Note**
> note

Data attachments for item stacks have been superceeded by vanilla's [data components](/docs/1.21.5/items/datacomponents).
...
To sync block entity, chunk, or entity attachments to a client, you need to [send a packet to the client](/docs/1.21.5/networking/) yourself. For chunks, you can use `ChunkWatchEvent.Sent` to know when to send chunk data to a player.

## Copying data on player death

By default, [entity](/docs/1.21.5/entities/) data attachments are not copied on player death. To automatically copy an attachment on player death, set `copyOnDeath` in the attachment builder.
