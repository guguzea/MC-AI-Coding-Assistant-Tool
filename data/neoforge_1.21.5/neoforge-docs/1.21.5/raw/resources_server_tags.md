...
url: "https://docs.neoforged.net/docs/1.21.5/resources/server/tags/"
platform: "neoforge"
fetchedAt: "2026-09-07T03:59:55.770Z"
---
# Tags
...
There are a few exceptions to this rule for some tags that tie closely into NeoForge systems. This includes many [damage type](/docs/1.21.5/resources/server/damagetypes) tags, for example.
...
To create a custom tag provider for a custom [registry](/docs/1.21.5/concepts/registries), or for a vanilla or NeoForge registry that doesn't have a tag provider by default, you can also create custom tag providers like so (using recipe type tags as an example):
