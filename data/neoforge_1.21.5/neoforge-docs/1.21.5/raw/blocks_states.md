...
url: "https://docs.neoforged.net/docs/1.21.5/blocks/states/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:51:54.321Z"
---
# Blockstates
...
As with blocks, every `BlockState` exists exactly once in memory. This means that `==` can and should be used to compare `BlockState`s. `BlockState` is also a final class, meaning it cannot be extended. **Any functionality goes in the corresponding [Block](/docs/1.21.5/blocks/) class!**
...
### Blockstates vs. [Block Entities](/docs/1.21.5/blockentities/)
