...
Minecraft uses `.nbt` files extensively, for example for structure files in [datapacks](/docs/1.21.5/resources/#data). Region files (`.mca`) that contain the contents of a region (i.e. a collection of chunks), as well as the various `.dat` files used in different places by the game, are NBT files as well.
...
NBT is used in a lot of places in Minecraft. Some of the most common examples include [BlockEntity](/docs/1.21.5/blockentities/)s and [Entitys](/docs/1.21.5/entities/).

> **Note**
> note

`ItemStack`s abstract away the usage of NBT into [data components](/docs/1.21.5/items/datacomponents).
