...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.11.2-13.20.0.2228/net/minecraft/world/gen/structure/ComponentScatteredFeaturePieces.JunglePyramid.html"
sourceType: javadoc
---
...
- `JunglePyramid()`
- `JunglePyramid(java.util.Random rand, int x, int z)`
