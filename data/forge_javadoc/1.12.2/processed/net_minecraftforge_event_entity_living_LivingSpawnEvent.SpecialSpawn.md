...
- `@Deprecated SpecialSpawn(EntityLiving entity, World world, float x, float y, float z)`
- `SpecialSpawn(EntityLiving entity, World world, float x, float y, float z, MobSpawnerBaseLogic spawner)`
