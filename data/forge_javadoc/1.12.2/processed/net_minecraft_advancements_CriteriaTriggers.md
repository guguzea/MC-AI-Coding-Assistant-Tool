...
**Inheritance:** java.lang.Object → net.minecraft.advancements.CriteriaTriggers

## Class signature

```java
public class CriteriaTriggers extends java.lang.Object
```
...
- `static<T extends ICriterionInstance> ICriterionTrigger<T> get(ResourceLocation id)`
- `static java.lang.Iterable<? extends ICriterionTrigger<?>> getAll()`
- `static<T extends ICriterionTrigger> T register(T criterion)`
