...
- `<T> ISearchTree<T> getSearchTree(SearchTreeManager.Key<T> key)`
...
- `void populateSearchTreeManager()`
- `@Deprecated void refreshResources()`
- `void resize(int width, int height)`
- `void run()`
- `void runTick()`
- `@Deprecated <any> scheduleResourcesRefresh()`
