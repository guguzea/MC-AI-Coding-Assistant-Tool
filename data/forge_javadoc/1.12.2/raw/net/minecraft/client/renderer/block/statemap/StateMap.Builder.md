...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraft/client/renderer/block/statemap/StateMap.Builder.html"
sourceType: javadoc
---
...
- `StateMap build()`
- `StateMap.Builder ignore(IProperty<?>... ignores)`
