...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraft/client/model/TexturedQuad.html"
sourceType: javadoc
---
...
```java
public class TexturedQuad extends java.lang.Object
```
...
- `void draw(BufferBuilder renderer, float scale)`
- `void flipFace()`
