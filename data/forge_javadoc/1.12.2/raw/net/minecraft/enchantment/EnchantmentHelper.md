...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraft/enchantment/EnchantmentHelper.html"
sourceType: javadoc
---
...
- `static ItemStack addRandomEnchantment(java.util.Random random, ItemStack stack, int level, boolean allowTreasure)`
...
- `static java.util.List<EnchantmentData> buildEnchantmentList(java.util.Random randomIn, ItemStack itemStackIn, int level, boolean allowTreasure)`
...
- `static int getFishingLuckBonus(ItemStack p_191529_0_)`
- `static int getFishingSpeedBonus(ItemStack p_191528_0_)`
...
- `static float getSweepingDamageRatio(EntityLivingBase p_191527_0_)`
