...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraftforge/client/event/RenderPlayerEvent.Post.html"
sourceType: javadoc
---
...
- `@Deprecated Post(EntityPlayer player, RenderPlayer renderer, float tick)`
- `Post(EntityPlayer player, RenderPlayer renderer, float tick, double x, double y, double z)`
