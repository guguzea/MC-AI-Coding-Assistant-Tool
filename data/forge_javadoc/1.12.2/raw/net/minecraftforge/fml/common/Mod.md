...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraftforge/fml/common/Mod.html"
sourceType: javadoc
---
...
- `java.lang.String dependencies` — A dependency string for this mod, which specifies which mod(s) it depends on in order to run.
