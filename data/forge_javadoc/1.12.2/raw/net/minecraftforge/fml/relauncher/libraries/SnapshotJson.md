---
title: "SnapshotJson"
description: "This is different from the standard maven snapshot metadata. Because none of that data is exposed to us as a user of gradle/maven/whatever. So we JUST use the timestamp. { \"latest\": \"yyyyMMdd.hhmms"
