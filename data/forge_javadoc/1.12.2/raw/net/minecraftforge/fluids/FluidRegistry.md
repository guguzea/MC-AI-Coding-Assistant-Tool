...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraftforge/fluids/FluidRegistry.html"
sourceType: javadoc
---
...
- `static int getMaxID()`
- `static java.lang.String getModId(FluidStack fluidStack)`
...
- `static boolean hasBucket(Fluid fluid)`
- `static void initFluidIDs(<any> newfluidIDs, java.util.Set<java.lang.String> defaultNames)` — Called by Forge to prepare the ID map for server -> client sync.
