...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.12.2-14.23.5.2859/net/minecraftforge/common/config/Property.html"
sourceType: javadoc
---
...
- `Property(java.lang.String name, java.lang.String value, Property.Type type, java.lang.String[] validValues, java.lang.String[] validValuesDisplay)`
- `Property(java.lang.String name, java.lang.String value, Property.Type type, java.lang.String[] validValues, java.lang.String[] validValuesDisplay, java.lang.String langKey)`
...
- `java.lang.String[] getValidValues()` — Gets the array of valid values that this String Property can be set to, or null or empty if not defined.
- `java.lang.String[] getValidValuesDisplay()` — Gets the array of the config GUI display versions of the valid values that this String Property can be set to, or null or empty if not defined.
...
- `void setHasSlidingControl(boolean b)`
...
- `Property setValidValuesDisplay(java.lang.String[] validValuesDisplay)` — Sets the array of the config GUI display versions of the valid values that this String Property can be set to.
