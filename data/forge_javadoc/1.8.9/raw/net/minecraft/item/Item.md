---
title: "Item"
description: "If true, render the object in full 3D, like weapons and tools."
...
- `public WeightedRandomChestContent getChestGenBase( ChestGenHooks chest, java.util.Random rnd, WeightedRandomChestContent original)`
- `public boolean doesSneakBypassUse( World world, BlockPos pos, EntityPlayer player)`
- `public void onArmorTick( World world, EntityPlayer player, ItemStack itemStack)`
- `public boolean isValidArmor( ItemStack stack, int armorType, Entity entity)`
- `public boolean isBookEnchantable( ItemStack stack, ItemStack book)`
- `public java.lang.String getArmorTexture( ItemStack stack, Entity entity, int slot, java.lang.String type)`
- `public FontRenderer getFontRenderer( ItemStack stack)`
- `@Deprecated public ModelBiped getArmorModel( EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot)`
...
- `public final Item setRegistryName(java.lang.String name)`
- `public final Item setRegistryName( ResourceLocation name)`
