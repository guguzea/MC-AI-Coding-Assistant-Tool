...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.8.9-11.15.1.2318/net/minecraft/client/renderer/OpenGlHelper.html"
sourceType: javadoc
---
...
- `static int glCreateShader(int type)` — creates a shader with the given mode and returns the GL id. params: mode
...
- `static void glDeleteShader(int p_153180_0_)`
...
- `static int glGenFramebuffers()` — Calls the appropriate glGenFramebuffers method and returns the newly created fbo, or returns -1 if not supported.
- `static int glGenRenderbuffers()`
- `static int glGetAttribLocation(int p_153164_0_, java.lang.CharSequence p_153164_1_)`
...
- `static void initializeTextures()` — Initializes the texture constants to be used when rendering lightmap values
- `static boolean isFramebufferEnabled()`
- `static void setActiveTexture(int texture)` — Sets the current lightmap texture to the specified OpenGL constant
- `static void setClientActiveTexture(int texture)` — Sets the current lightmap texture to the specified OpenGL constant
- `static void setLightmapTextureCoords(int target, float p_77475_1_, float p_77475_2_)` — Sets the current coordinates of the given lightmap texture
- `static boolean useVbo()`

## Fields

- `static boolean ati`
- `static int defaultTexUnit` — An OpenGL constant corresponding to GL_TEXTURE0, used when setting data pertaining to auxiliary OpenGL texture units.
...
- `static int lightmapTexUnit` — An OpenGL constant corresponding to GL_TEXTURE1, used when setting data pertaining to auxiliary OpenGL texture units.
