...
- `NetHandlerPlayClient(Minecraft mcIn, GuiScreen p_i46300_2_, NetworkManager p_i46300_3_, GameProfile p_i46300_4_)`

## Methods

- `void addToSendQueue(Packet p_147297_1_)`
- `void cleanup()` — Clears the WorldClient instance associated with this NetHandlerPlayClient
...
- `NetworkPlayerInfo getPlayerInfo(java.lang.String p_175104_1_)` — Gets the client's description information about another player on the server.
- `NetworkPlayerInfo getPlayerInfo(java.util.UUID p_175102_1_)`
