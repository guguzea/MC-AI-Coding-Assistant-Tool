...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.8.9-11.15.1.2318/net/minecraft/network/NetHandlerPlayServer.html"
sourceType: javadoc
---
...
- `void kickPlayerFromServer(java.lang.String reason)` — Kick a player from the server with a reason
...
- `void setPlayerLocation(double x, double y, double z, float yaw, float pitch, java.util.Set<S08PacketPlayerPosLook.EnumFlags> relativeSet)`
