...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.8.9-11.15.1.2318/net/minecraftforge/oredict/OreDictionary.html"
sourceType: javadoc
---
...
- `static int[] getOreIDs(ItemStack stack)` — Gets all the integer ID for the ores that the specified item stakc is registered to.
