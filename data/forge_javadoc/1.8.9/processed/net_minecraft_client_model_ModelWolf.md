...
- `ModelRenderer wolfBody` — The wolf's body
- `ModelRenderer wolfHeadMain` — main box for the wolf head
- `ModelRenderer wolfLeg1` — Wolf'se first leg
- `ModelRenderer wolfLeg2` — Wolf's second leg
- `ModelRenderer wolfLeg3` — Wolf's third leg
- `ModelRenderer wolfLeg4` — Wolf's fourth leg