...
- `public IForgeRegistry < VillagerRegistry.VillagerProfession > getRegistry()`
- `public static void setRandomProfession( EntityVillager entity, java.util.Random rand)`
- `public static void setRandomProfession( EntityZombie entity, java.util.Random rand)`
- `public static void onSetProfession( EntityVillager entity, VillagerRegistry.VillagerProfession prof)`
- `public static void onSetProfession( EntityVillager entity, int network)`
- `public static void onSetProfession( EntityZombie entity, VillagerRegistry.VillagerProfession prof)`
