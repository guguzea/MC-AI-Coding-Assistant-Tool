...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.7.10-10.13.4.1614/net/minecraft/block/BlockFire.html"
sourceType: javadoc
---
...
- `boolean canBlockCatchFire(IBlockAccess p_149844_1_, int p_149844_2_, int p_149844_3_, int p_149844_4_)`
- `boolean canPlaceBlockAt(World p_149742_1_, int p_149742_2_, int p_149742_3_, int p_149742_4_)`
- `boolean func_149698_L()`
- `void func_149842_a(int p_149842_1_, int p_149842_2_, int p_149842_3_)`
- `static void func_149843_e()`
- `int func_149846_a(World p_149846_1_, int p_149846_2_, int p_149846_3_, int p_149846_4_, int p_149846_5_)`
- `AxisAlignedBB getCollisionBoundingBoxFromPool(World p_149668_1_, int p_149668_2_, int p_149668_3_, int p_149668_4_)`
- `IIcon getFireIcon(int p_149840_1_)`
