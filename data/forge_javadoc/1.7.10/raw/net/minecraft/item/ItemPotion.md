...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.7.10-10.13.4.1614/net/minecraft/item/ItemPotion.html"
sourceType: javadoc
---
...
- `static IIcon func_94589_d(java.lang.String p_94589_0_)`
- `int getColorFromDamage(int p_77620_1_)`
- `int getColorFromItemStack(ItemStack p_82790_1_, int p_82790_2_)`
- `java.util.List getEffects(int p_77834_1_)`
- `java.util.List getEffects(ItemStack p_77832_1_)`
...
- `boolean isEffectInstant(int p_77833_1_)`
- `static boolean isSplash(int p_77831_0_)`
