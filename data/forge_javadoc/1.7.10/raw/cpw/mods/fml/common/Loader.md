...
source: "https://skmedix.github.io/ForgeJavaDocs/javadoc/forge/1.7.10-10.13.4.1614/cpw/mods/fml/common/Loader.html"
sourceType: javadoc
---

# Loader

**Inheritance:** java.lang.Object → cpw.mods.fml.common.Loader
...
- `java.util.List<java.lang.String> fireMissingMappingEvent(java.util.LinkedHashMap<java.lang.String, java.lang.Integer> missing, boolean isLocalWorld, GameData gameData, java.util.Map<java.lang.String, java.lang.Integer[]> remaps)` — Fire a FMLMissingMappingsEvent to let mods determine how blocks/items defined in the world save, but missing from the runtime, are to be handled.
- `void fireRemapEvent(java.util.Map<java.lang.String, java.lang.Integer[]> remaps)`
...
- `java.lang.ClassLoader getModClassLoader()`
