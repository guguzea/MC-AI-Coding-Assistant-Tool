...
There are a few exceptions to this rule for some tags that tie closely into NeoForge systems. This includes many [damage type](/docs/1.21.8/resources/server/damagetypes) tags, for example.
