...
url: "https://docs.neoforged.net/docs/1.21.8/datastorage/nbt/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:51:27.621Z"
---
...
Minecraft uses `.nbt` files extensively, for example for structure files in [datapacks](/docs/1.21.8/resources/#data). Region files (`.mca`) that contain the contents of a region (i.e. a collection of chunks), as well as the various `.dat` files used in different places by the game, are NBT files as well.
...
NBT is used in a lot of places in Minecraft. [BlockEntitys](/docs/1.21.8/blockentities/)s and [Entitys](/docs/1.21.8/entities/) abstract NBT usage into [value accesses](/docs/1.21.8/datastorage/valueio). `ItemStack`s abstract the usage into [data components](/docs/1.21.8/items/datacomponents).
