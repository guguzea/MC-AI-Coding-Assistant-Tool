...
platform: "neoforge"
fetchedAt: "2026-09-12T12:06:40.170Z"
---
...
The [client item](/docs/1.21.8/resources/client/models/items) JSON (in `assets/<namespace>/items`) is compiled and baked into an `ItemModel` for a given `Item` to be used by the `ItemStack`. The process of creating the `ItemModel` goes like so:
