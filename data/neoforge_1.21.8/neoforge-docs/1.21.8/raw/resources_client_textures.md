...
url: "https://docs.neoforged.net/docs/1.21.8/resources/client/textures/"
platform: "neoforge"
fetchedAt: "2026-09-12T12:06:43.505Z"
---
# Textures

All textures in Minecraft are PNG files located within a namespace's `textures` folder. JPG, GIF and other image formats are not supported. The path of [resource locations](/docs/1.21.8/misc/resourcelocation) referring to textures is generally relative to the `textures` folder, so for example, the resource location `examplemod:block/example_block` refers to the texture file at `assets/examplemod/textures/block/example_block.png`.
