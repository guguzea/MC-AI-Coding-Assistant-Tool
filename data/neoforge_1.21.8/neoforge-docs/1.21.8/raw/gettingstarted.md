...
You should always test your mod in a dedicated server environment. This includes [client-only mods](/docs/1.21.8/concepts/sides), as these should not do anything when loaded on the server.
