...
platform: "neoforge"
fetchedAt: "2026-09-07T04:00:25.911Z"
---
# Attributes
...
If needed, you can also add your own attributes. Like many other systems, attributes are a [registry](/docs/1.21.8/concepts/registries), and you can register your own objects to it. To get started, create a `DeferredRegister` like so:
