...
url: "https://docs.neoforged.net/docs/1.21.8/misc/updatechecker/"
platform: "neoforge"
fetchedAt: "2026-09-07T04:00:38.604Z"
---
...
- NeoForge uses an internal algorithm to determine whether one version string of your mod is "newer" than another. Most versioning schemes should be compatible, but see the `ComparableVersion` class if you are concerned about whether your scheme is supported. Adherence to [Maven versioning](/docs/1.21.8/gettingstarted/versioning) is highly recommended.
