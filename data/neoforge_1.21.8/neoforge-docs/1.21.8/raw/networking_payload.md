...
url: "https://docs.neoforged.net/docs/1.21.8/networking/payload/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:51:32.877Z"
---
...
<li class="">The [stream codec](/docs/1.21.8/networking/streamcodecs) is used to read and write the payload to and from the buffer sent across the network</li>
...
The client payload handler has its own event `RegisterClientPayloadHandlersEvent` to protect against code reaching across both logical and physical [sides](/docs/1.21.8/concepts/sides).
...
With your own payloads you can then use those to configure the client and server using [Configuration Tasks](/docs/1.21.8/networking/configuration-tasks).
