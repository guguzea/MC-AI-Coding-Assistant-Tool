...
url: "https://docs.neoforged.net/docs/datastorage/nbt/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:41:00.464Z"
---
...
Minecraft uses `.nbt` files extensively, for example for structure files in [datapacks](/docs/resources/#data). Region files (`.mca`) that contain the contents of a region (i.e. a collection of chunks), as well as the various `.dat` files used in different places by the game, are NBT files as well.
...
NBT is used in a lot of places in Minecraft. [BlockEntitys](/docs/blockentities/)s and [Entitys](/docs/entities/) abstract NBT usage into [value accesses](/docs/datastorage/valueio). `ItemStack`s abstract the usage into [data components](/docs/items/datacomponents).
