...
url: "https://docs.neoforged.net/docs/blocks/states/"
platform: "neoforge"
fetchedAt: "2026-06-01T10:40:44.441Z"
---
# Blockstates
...
As with blocks, every `BlockState` exists exactly once in memory. This means that `==` can and should be used to compare `BlockState`s. `BlockState` is also a final class, meaning it cannot be extended. **Any functionality goes in the corresponding [Block](/docs/blocks/) class!**
...
### Blockstates vs. [Block Entities](/docs/blockentities/)
...
- Created by calling `EnumProperty#create(String name, Class enumClass)`.
