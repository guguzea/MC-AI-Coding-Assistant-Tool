...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/events.md
> 版本：1.21.11
> GitHub 路径：develop/events.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T03:52:42.645Z
> SHA256：90505b6ddd66f7e341bae7dfb20acbc4ab573ecaabe387e9cd2d350904ba89c5
> 分支：main
...
@[code lang=java transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transclude={38-40}](@/reference/1.21.11/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code highlight={6-7} transcludeWith=:::2](@/reference/1.21.11/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transcludeWith=:::](@/reference/1.21.11/src/main/java/com/example/docs/event/SheepShearCallback.java)

Let's look at this more in-depth. When the invoker is called, we iterate over all listeners:

@[code lang=java transclude={21-22}](@/reference/1.21.11/src/main/java/com/example/docs/event/SheepShearCallback.java)

We then call our method (in this case, `interact`) on the listener to get its response:

@[code lang=java transclude={33-33}](@/reference/1.21.11/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transclude={25-30}](@/reference/1.21.11/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transclude={9-16}](@/reference/1.21.11/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transcludeWith=:::](@/reference/1.21.11/src/main/java/com/example/docs/mixin/event/SheepEntityMixin.java)
...
@[code lang=java transcludeWith=:::3](@/reference/1.21.11/src/main/java/com/example/docs/event/ExampleModEvents.java)
