...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/data-generation/item-models.md
> 版本：1.21.11
> GitHub 路径：develop/data-generation/item-models.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:23.763Z
> SHA256：17de03d202c8f9aea6486d9f1ed7e4e633f940a118ab3d6918c35a3aa721266b
> 分支：main
...
@[code transcludeWith=:::provider](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

Register this class in your `DataGeneratorEntrypoint` within the `onInitializeDataGenerator` method.

@[code transcludeWith=:::datagen-models:register](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code transcludeWith=:::generated](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

== Client Item

`generated/assets/example-mod/items/ruby.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/ruby.json)

== Item Model

`generated/assets/example-mod/models/item/ruby.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/ruby.json)
...
@[code transcludeWith=:::handheld](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

== Client Item

`generated/assets/example-mod/items/guidite_axe.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/guidite_axe.json)

== Item Model

`generated/assets/example-mod/models/item/guidite_axe.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/guidite_axe.json)
...
@[code transcludeWith=:::dyeable](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/leather_gloves.json)

== Item Model

`generated/assets/example-mod/models/item/leather_gloves.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/leather_gloves.json)
...
@[code transcludeWith=:::condition](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/flashlight.json)

== Item Models

`generated/assets/example-mod/models/item/flashlight.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/flashlight.json)

`generated/assets/example-mod/models/item/flashlight_lit.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/flashlight_lit.json)
...
@[code transcludeWith=:::composite](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

== Client Item

`generated/assets/example-mod/items/enhanced_hoe.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/enhanced_hoe.json)

== Item Models

`generated/assets/example-mod/models/item/enhanced_hoe.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/enhanced_hoe.json)

`generated/assets/example-mod/models/item/enhanced_hoe_plus.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/enhanced_hoe_plus.json)
...
@[code transcludeWith=:::select](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

== Client Item

`generated/assets/example-mod/items/dimensional_crystal.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/dimensional_crystal.json)

== Item Models

`generated/assets/example-mod/models/item/dimensional_crystal_overworld.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/dimensional_crystal_overworld.json)

`generated/assets/example-mod/models/item/dimensional_crystal_nether.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/dimensional_crystal_nether.json)

`generated/assets/example-mod/models/item/dimensional_crystal_end.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/dimensional_crystal_end.json)
...
@[code transcludeWith=:::range-dispatch](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)

== Client Item

`generated/assets/example-mod/items/throwing_knives.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/throwing_knives.json)

== Item Models

`generated/assets/example-mod/models/item/throwing_knives_one.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/throwing_knives_one.json)

`generated/assets/example-mod/models/item/throwing_knives_two.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/throwing_knives_two.json)

`generated/assets/example-mod/models/item/throwing_knives_three.json`

@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/throwing_knives_three.json)
...
@[code transcludeWith=:::custom-item-model-generator:::](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code](@/reference/1.21.11/src/main/resources/assets/example-mod/models/item/scaled2x.json)
...
@[code transcludeWith=:::custom-item-model:::](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code transcludeWith=:::custom-item-datagen-method](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
...
@[code transcludeWith=:::custom-balloon](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModModelProvider.java)
