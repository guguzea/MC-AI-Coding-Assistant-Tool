...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/rendering/world.md
> 版本：1.21.11
> GitHub 路径：develop/rendering/world.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:51:16.786Z
> SHA256：af5b6a041df7fa5e4f6e7f7a43e2b5565aecf007b80b1bdf02959bb84f710df0
> 分支：main
...
@[code lang=java transcludeWith=:::custom-pipelines:define-pipeline](@/reference/1.21.11/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:extraction-phase](@/reference/1.21.11/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:drawing-phase](@/reference/1.21.11/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:clean-up](@/reference/1.21.11/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
@[code lang=java](@/reference/1.21.11/src/client/java/com/example/docs/mixin/client/GameRendererMixin.java)

### Final Code {#final-code}

Combining all the steps from above, we get a simple class that renders a waypoint at `(0, 100, 0)` through walls.

@[code lang=java](@/reference/1.21.11/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
