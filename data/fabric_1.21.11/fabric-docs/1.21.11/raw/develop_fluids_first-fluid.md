...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/fluids/first-fluid.md
> 版本：1.21.11
> GitHub 路径：develop/fluids/first-fluid.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:33.299Z
> SHA256：92466a56c7960f42793ace9e8961b52e8f556b81209b28fca06e6b204edf57b2
> 分支：main
...
@[code transcludeWith=:::abstractFluid](@/reference/1.21.11/src/main/java/com/example/docs/fluid/custom/AcidFluid.java)

Inside `AcidFluid`, we'll create two subclasses for the `Source` and `Flowing` fluids.

@[code transcludeWith=:::fluidSubclasses](@/reference/1.21.11/src/main/java/com/example/docs/fluid/custom/AcidFluid.java)
...
@[code transcludeWith=:::register](@/reference/1.21.11/src/main/java/com/example/docs/fluid/ModFluids.java)
...
@[code transcludeWith=:::sources](@/reference/1.21.11/src/main/java/com/example/docs/fluid/custom/AcidFluid.java)
...
@[code transcludeWith=:::acid](@/reference/1.21.11/src/main/java/com/example/docs/block/ModBlocks.java)

Then, override this method in `AcidFluid` to associate your block with the fluid:

@[code transcludeWith=:::legacyBlock](@/reference/1.21.11/src/main/java/com/example/docs/fluid/custom/AcidFluid.java)
...
@[code transcludeWith=:::acid_bucket](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)

Then, override this method in `AcidFluid` to associate your bucket with the fluid:

@[code transcludeWith=:::bucket](@/reference/1.21.11/src/main/java/com/example/docs/fluid/custom/AcidFluid.java)
...
<<< @/reference/1.21.11/src/main/generated/data/example-mod/tags/fluid/acid.json
...
<<< @/reference/1.21.11/src/main/generated/data/minecraft/tags/fluid/water.json
