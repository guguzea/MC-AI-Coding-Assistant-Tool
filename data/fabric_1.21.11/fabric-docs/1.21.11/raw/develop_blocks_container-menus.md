...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/blocks/container-menus.md
> 版本：1.21.11
> GitHub 路径：develop/blocks/container-menus.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:06.644Z
> SHA256：fc02ebe1979bf16f21017f62cec9b38f10e99937a8ecde670c09931411000e3c
> 分支：main
...
@[code transcludeWith=:::block](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/DirtChestBlock.java)

@[code transcludeWith=:::be](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
@[code transcludeWith=:::use](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/DirtChestBlock.java)
...
@[code transcludeWith=:::menu](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
@[code transcludeWith=:::menu](@/reference/1.21.11/src/main/java/com/example/docs/menu/custom/DirtChestMenu.java)
...
@[code transcludeWith=:::registerMenu](@/reference/1.21.11/src/main/java/com/example/docs/menu/ModMenuType.java)

We can now set the return value of `createMenu` in the block entity to use our menu:

@[code transcludeWith=:::providerImplemented](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
@[code transcludeWith=:::screen](@/reference/1.21.11/src/client/java/com/example/docs/rendering/screens/inventory/DirtChestScreen.java)
...
@[code transcludeWith=:::registerScreens](@/reference/1.21.11/src/client/java/com/example/docs/ExampleModScreens.java)
