...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/blocks/blockstates.md
> 版本：1.21.11
> GitHub 路径：develop/blocks/blockstates.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:05.282Z
> SHA256：0258bc339c58b566fe61b2e741330b8990994107bb260bd9ffd3b63adec3fd05
> 分支：main
...
@[code transcludeWith=:::3](@/reference/1.21.11/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/block/condensed_oak_log_horizontal.json)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/blockstates/condensed_oak_log.json)
...
@[code transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code transcludeWith=:::2](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)

You'll also have to set a default state for the `activated` property in the constructor of your custom block.

@[code transcludeWith=:::3](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code transcludeWith=:::4](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/blockstates/prismarine_lamp.json)
...
@[code transcludeWith=:::5](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)

@[code transcludeWith=:::4](@/reference/1.21.11/src/main/java/com/example/docs/block/ModBlocks.java)
