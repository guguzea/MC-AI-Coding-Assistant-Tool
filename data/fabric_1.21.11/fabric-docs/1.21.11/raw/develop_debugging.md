...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/debugging.md
> 版本：1.21.11
> GitHub 路径：develop/debugging.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:26.525Z
> SHA256：9385b406fef5382566ef4c01851369bfebb0b6fcc1408808963570c7da01a6a3
> 分支：main
...
@[code lang=java transcludeWith=:::problems:basic-logger-definition](@/reference/1.21.11/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:using-logger](@/reference/1.21.11/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=java transcludeWith=:::problems:logger-usage-example](@/reference/1.21.11/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=xml](@/reference/1.21.11/log4j-dev.xml)

Then in the `build.gradle`, tell Loom to use our new configuration.

@[code lang=java transcludeWith=:::debug-logging](@/reference/1.21.11/build.gradle)

Now, when we send debug log messages, we'll be able to see them in the console.

@[code lang=java transcludeWith=:::problems:debug-logging](@/reference/1.21.11/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:breakpoints](@/reference/1.21.11/src/main/java/com/example/docs/debug/TestItem.java)
