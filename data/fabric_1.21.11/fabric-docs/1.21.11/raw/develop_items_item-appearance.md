...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/items/item-appearance.md
> 版本：1.21.11
> GitHub 路径：develop/items/item-appearance.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:51:02.340Z
> SHA256：f5da9f95baaf7dada84fe44ea26c9107e6b185474c884a37896227df1a324762
> 分支：main
...
@[code lang=java transcludeWith=:::item](@/reference/1.21.11/src/main/java/com/example/docs/appearance/ExampleModAppearance.java)
...
@[code lang=java transcludeWith=:::tint_source](@/reference/1.21.11/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transclude={17-20}](@/reference/1.21.11/src/client/java/com/example/docs/appearance/RainTintSource.java)

We can then return this Codec in `type()`.

@[code lang=java transclude={35-38}](@/reference/1.21.11/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transclude={26-33}](@/reference/1.21.11/src/client/java/com/example/docs/appearance/RainTintSource.java)
...
@[code lang=java transcludeWith=:::item_tint_source](@/reference/1.21.11/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)

Once this is done, we can use our item tint source in a client item definition.

@[code lang=json transclude](@/reference/1.21.11/src/main/generated/assets/example-mod/items/waxcap.json)
