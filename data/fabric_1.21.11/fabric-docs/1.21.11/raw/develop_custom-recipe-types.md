...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/custom-recipe-types.md
> 版本：1.21.11
> GitHub 路径：develop/custom-recipe-types.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:16.031Z
> SHA256：f37c8493fc59937bdc49de7b4e545ddfb87e2e58a1f5b30848380813e6e832b1
> 分支：main
...
@[code transcludeWith=:::recipeInput](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipeInput.java)
...
@[code transcludeWith=:::baseClass](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::implementing](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::mapCodec](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java)

The stream codec can be created in a similar way using `StreamCodec#composite`:

@[code transcludeWith=:::streamCodec](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java)

Let's use these codecs to implement the methods from `RecipeSerializer`:

@[code transcludeWith=:::implementing](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java)
...
@[code transcludeWith=:::registration](@/reference/1.21.11/src/main/java/com/example/docs/recipe/ExampleModRecipes.java)

Back to our recipe class, we can now add the methods that return the objects we just registered:

@[code transcludeWith=:::implementRegistryObjects](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::recipeBook](@/reference/1.21.11/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code](@/reference/1.21.11/src/main/resources/data/example-mod/recipe/upgrading/diamond_pickaxe.json)
...
@[code transcludeWith=:::menu](@/reference/1.21.11/src/main/java/com/example/docs/menu/custom/UpgradingMenu.java)
...
@[code transcludeWith=:::recipeSync](@/reference/1.21.11/src/main/java/com/example/docs/recipe/ExampleModRecipes.java)

Once synchronized, recipes can be retrieved at any point from the client level's recipe manager:

@[code transcludeWith=:::recipeSyncClient](@/reference/1.21.11/src/client/java/com/example/docs/ExampleModRecipesClient.java)
