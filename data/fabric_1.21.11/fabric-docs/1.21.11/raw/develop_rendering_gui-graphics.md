...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/rendering/gui-graphics.md
> 版本：1.21.11
> GitHub 路径：develop/rendering/gui-graphics.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:51:12.903Z
> SHA256：cea0a36852cc98ae5c3c5f12f82009d2b1fd7a8cbc2fa2e5f770de5b7738e3dd
> 分支：main
...
@[code lang=java transcludeWith=:::1](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::2](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::3](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::4](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::5](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::6](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
...
@[code lang=java transcludeWith=:::7](@/reference/1.21.11/src/client/java/com/example/docs/rendering/DrawContextExampleScreen.java)
