...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/game-rules.md
> 版本：1.21.11
> GitHub 路径：develop/game-rules.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:34.737Z
> SHA256：5530500dde7949e4a70072ba54839b7821bca5a566efd68c4902d91ac787f9f8
> 分支：main
...
@[code lang=java transcludeWith=:::gameruleClass](@/reference/1.21.11/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java)
...
@[code lang=java transcludeWith=:::double](@/reference/1.21.11/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java)
...
@[code lang=java transclude={44-44}](@/reference/1.21.11/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java)

You can also use this to access the values of vanilla game rules:

@[code lang=java transcludeWith=:::vanilla](@/reference/1.21.11/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java)

For example, for a rule that applies blindness to every player when true, the implementation would be:

@[code lang=java transcludeWith=:::badvision](@/reference/1.21.11/src/main/java/com/example/docs/gamerule/ExampleModGameRules.java)
...
@[code lang=java transcludeWith=:::gamerule-name](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java)
...
@[code lang=java transcludeWith=:::gamerule-description](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java)
