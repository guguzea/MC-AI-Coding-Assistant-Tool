...
> 来源：https://raw.githubusercontent.com/FabricMC/fabric-docs/main/versions/1.21.11/develop/entities/damage-types.md
> 版本：1.21.11
> GitHub 路径：develop/entities/damage-types.md
> 抓取源：github_raw_versioned
> 抓取时间：2026-08-20T09:50:29.868Z
> SHA256：86670b18abdf816bcdab69443e6fc5b7309dc47fb33ea3502aa250dd08396371
> 分支：main
...
@[code lang=json](@/reference/1.21.11/src/main/generated/data/example-mod/damage_type/tater.json)
...
@[code lang=java transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/damage/ExampleModDamageTypes.java)
...
@[code lang=java transclude={22-26}](@/reference/1.21.11/src/main/java/com/example/docs/damage/TaterBlock.java)

Then, we call `entity.damage()` with our `DamageSource` and an amount.

@[code lang=java transclude={27-27}](@/reference/1.21.11/src/main/java/com/example/docs/damage/TaterBlock.java)

The complete block implementation:

@[code lang=java transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/damage/TaterBlock.java)
...
@[code lang=json](@/reference/1.21.11/src/main/generated/data/minecraft/tags/damage_type/bypasses_armor.json)
